...
!(function (t, e) {
 ...
 function mt(t) {
  ...
  const o =
   s.xmin !== e.min || s.xmax !== e.max || s.ymin !== i.min || s.ymax !== i.max;
  ...
  _update(t = Date.now()) {
   ...
   this._charts.forEach((i, s) => {
    ...
    r && (s.draw(), this._notify(s, i, t, 'progress')),
     n.length ||
      ((i.running = !1), this._notify(s, i, t, 'complete'), (i.initial = !1)),
     (e += n.length);
   }),
    (this._lastDate = t),
    0 === e && (this._running = !1);
   ...
   (m = e[t % a]),
    m.skip ||
     ...
     p !== b &&
      ...
      (b = p)));
  return (
   null !== _ && g.push(Ei({ start: _, end: d, loop: u, count: a, style: f })),
   g
  );
 }
 function Ii(t, e) {
 ...
 class bn {
  ...
  getOptionScopes(t, e, i) {
   ...
   return (
    0 === l.length && l.push(Object.create(null)), gn.has(e) && o.set(e, l), l
   );
  }
  chartOptionScopes() {
 ...
 class An {
  ...
  getContext() {
   return (
    this.$context || (this.$context = Ci(null, { chart: this, type: 'chart' }))
   );
  }
 ...
 class $n extends Ns {
  ...
  _updateRadius() {
   const t = this.chart,
    ...
    o =
     (n -
      Math.max(i.cutoutPercentage ? (n / 100) * i.cutoutPercentage : 1, 0)) /
 ...
 var Yn = Object.freeze({
  ...
  BubbleController: class extends Ns {
   ...
   resolveDataElementOptions(t, e) {
    ...
    const n = s.radius;
    return (
     'active' !== e && (s.radius = 0), (s.radius += l(i && i._custom, n)), s
    );
   }
  },
   ...
   updateElements(t, e, i, n) {
    ...
    for (let i = 0; i < _; ++i) {
     ...
     (_.skip = isNaN(w) || isNaN(k) || M),
      ...
      d &&
       (_.options =
        c || this.resolveDataElementOptions(i, g.active ? 'active' : n)),
 ...
 function qn(t, e, i, s, n, o) {
  ...
  if ((t.beginPath(), o)) {
   ...
   if (
    (t.arc(a, r, u, b - v / u, s, !0), t.arc(a, r, u, s, m + y / u, !0), y > 0)
   ) {
    const e = Xn(P, O, a, r);
 ...
 function Qn(t, e, i, s) {
  ...
  for (d = 0; d <= h; ++d)
   (u = n[(r + (p ? h - d : d)) % a]),
    u.skip ||
     (g ? (t.moveTo(u.x, u.y), (g = !1)) : c(t, f, u, p, o.stepped), (f = u));
 ...
 class Eo extends bo {
  ...
  getIndexAngle(t) {
   return G(
    t * (O / (this._pointLabels.length || 1)) + $(this.options.startAngle || 0),
   );
  }
 ...
 class No extends Js {
  ...
  _getLabelCapacity(t) {
   const e = this.options.time,
    ...
    a =
     Math.floor(this.isHorizontal() ? this.width / o.w : this.height / o.h) - 1;
   return a > 0 ? a : 1;
  }
  getDataTimestamps() {
   let t,
 ...
 function ta(t, e, i, s) {
  ...
  let n = e[t],
   o = i[t];
  return (
   'angle' === t && ((n = G(n)), (o = G(o))), { property: t, start: n, end: o }
  );
 }
 function ea(t, e, i) {
  for (; e > t; e--) {
 ...
 var ma = {
  ...
  beforeDraw(t, e, i) {
   ...
   for (let e = n.length - 1; e >= 0; --e) {
    const i = n[e].$filler;
    i &&
     (i.line.updateControlPoints(o, i.axis), s && i.fill && da(t.ctx, i, o));
   }
  },
 ...
 function Oa(t, e) {
  ...
  if (
   ...
   d &&
    (m += d * h.lineHeight + (d - 1) * e.titleSpacing + e.titleMarginBottom),
   x)
  ) {
   m +=
   ...
   for (
    ...
    for (
     b = s[y],
      ...
      a &&
       _.length &&
       (this._drawColorBox(e, t, y, g, i), (d = Math.max(c.lineHeight, r))),
      v = 0,
      w = _.length;
     v < w;
     ++v
   ...
   if (!s)
    return e.filter(
     (t) =>
      ...
      void 0 !==
       this.chart.getDatasetMeta(t.datasetIndex).controller.getParsed(t.index),
    );
