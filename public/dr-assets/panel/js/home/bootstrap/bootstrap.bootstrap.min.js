  ...
  P = (function () {
   ...
   return (
    ...
    (e._slide = function (t, e) {
     ...
     if (
      (t === N
       ? ((n = 'carousel-item-left'), (i = 'carousel-item-next'), (a = 'left'))
 ...
 var L = 'collapse',
  ...
  V = (function () {
   function t(t, e) {
    ...
    for (
     var n = [].slice.call(document.querySelectorAll(U)), i = 0, o = n.length;
     i < o;
     i++
    ) {
     var a = n[i],
    ...
    (e.show = function () {
     ...
     if (
      ...
      if ((o.default(this._element).trigger(a), !a.isDefaultPrevented())) {
       e &&
        (t._jQueryInterface.call(o.default(e).not(this._selector), 'hide'),
        n || o.default(e).data(R, null));
       var s = this._getDimension();
       o.default(this._element).removeClass(F).addClass(Q),
        (this._element.style[s] = 0),
        this._triggerArray.length &&
         o.default(this._triggerArray).removeClass(B).attr('aria-expanded', !0),
      ...
      if ((o.default(this._element).trigger(e), !e.isDefaultPrevented())) {
       ...
       if (i > 0)
        for (var a = 0; a < i; a++) {
         ...
         null !== l &&
          (o.default([].slice.call(document.querySelectorAll(l))).hasClass(q) ||
 ...
 var z = 'dropdown',
  ...
  lt = (function () {
   ...
   return (
    ...
    (e._getConfig = function (t) {
     return (
      (t = r({}, this.constructor.Default, o.default(this._element).data(), t)),
    ...
    (e._getPlacement = function () {
     ...
     return (
      t.hasClass('dropup')
       ? (e = o.default(this._menu).hasClass(G) ? 'top-end' : 'top-start')
     ...
     if (
      ...
      if (i || 27 !== e.which) {
       if (
        ...
        return (
         27 === e.which && o.default(n.querySelector(it)).trigger('focus'),
  ...
  Wt = (function () {
   ...
   return (
    ...
    (e.getTipElement = function () {
     return (
      (this.tip = this.tip || o.default(this.config.template)[0]), this.tip
     );
    }),
  ...
  se = (function () {
   ...
   return (
    ...
    (e._getConfig = function (t) {
     if (
      'string' !=
       typeof (t = r({}, oe, 'object' == typeof t && t ? t : {})).target &&
    ...
    (t._jQueryInterface = function (e) {
     return this.each(function () {
      var n = o.default(this),
       i = n.data(me);
      if (
       (i || ((i = new t(this, 'object' == typeof e && e)), n.data(me, i)),
       'string' == typeof e)
      ) {
       if ('undefined' == typeof i[e])
        throw new TypeError('No method named "' + e + '"');
