...
!(function (e, t) {
 'object' == typeof exports && 'undefined' != typeof module
  ...
  : 'function' == typeof define && define.amd
    ? define(['exports'], t)
    : t(
       ((e = 'undefined' != typeof globalThis ? globalThis : e || self).Popper =
        {}),
      );
})(this, function (e) {
 'use strict';
  ...
  var f =
    'clippingParents' === t
     ? (function (e) {
        var t = w(b(e)),
         o =
          ['absolute', 'fixed'].indexOf(m(e).position) >= 0 && r(e) ? E(e) : e;
        return n(o)
         ? t.filter(function (e) {
        ...
        for (var r = 0; r < f.orderedModifiers.length; r++)
         if (!0 !== f.reset) {
          var o = f.orderedModifiers[r],
           ...
           c = o.name;
          'function' == typeof i &&
           (f = i({ state: f, options: s, name: c, instance: u }) || f);
         } else (f.reset = !1), (r = -1);
       }
      }
     },
 ...
 function re(e) {
  ...
  if (u) {
   ...
   if (
    ...
    (M = A),
     (b -=
      (h && W === k && k.visualViewport ? k.visualViewport.height : W[H]) -
      o.height),
     (b *= p ? 1 : -1);
   if (i === P || ((i === D || i === A) && a === B))
    (j = L),
