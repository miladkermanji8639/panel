...
!(function (t, e) {
 ...
 function B(t, e) {
  ...
  return (
   parseFloat(t['border' + n + 'Width']) + parseFloat(t['border' + i + 'Width'])
  );
 }
 function q(t, e, n, i) {
  return Math.max(
      ...
      var c = e.priority,
       ...
       u = {
        primary: function (t) {
         var n = h[t];
         return (
          h[t] < l[t] && !e.escapeWithReference && (n = Math.max(h[t], l[t])),
          V({}, t, n)
         );
        },
     ...
     if (
      ...
      if (o || 27 !== n.which) {
       if (
        ...
        return (
         27 === n.which &&
          e(i.querySelector('[data-toggle="dropdown"]')).trigger('focus'),
  ...
  he = (function () {
   ...
   return (
    ...
    (n._getConfig = function (t) {
     if (
      'string' !=
       typeof (t = o({}, le, 'object' == typeof t && t ? t : {})).target &&
    ...
    (t._jQueryInterface = function (n) {
     return this.each(function () {
      var i = e(this),
       o = i.data('bs.tab');
      if (
       (o || ((o = new t(this)), i.data('bs.tab', o)), 'string' == typeof n)
      ) {
   ...
   return (
    ...
    (t._jQueryInterface = function (n) {
     return this.each(function () {
      ...
      if (
       (o ||
        ((o = new t(this, 'object' == typeof n && n)), i.data('bs.toast', o)),
       'string' == typeof n)
      ) {
       if ('undefined' == typeof o[n])
        throw new TypeError('No method named "' + n + '"');
