...
!(function (t, e) {
 'object' == typeof exports && 'undefined' != typeof module
  ...
  : 'function' == typeof define && define.amd
    ...
    : ((t =
       'undefined' != typeof globalThis ? globalThis : t || self).bootstrap = e(
       t.Popper,
      ));
})(this, function (t) {
 'use strict';
 ...
 class nt extends q {
  ...
  _getConfig(t) {
   return (
    ((t = { ...st, ...t }).toggle = Boolean(t.toggle)), d('collapse', t, it), t
   );
  }
  _getDimension() {
 ...
 class jt extends q {
  ...
  getTipElement() {
   ...
   const t = document.createElement('div');
   return (
    (t.innerHTML = this._config.template), (this.tip = t.children[0]), this.tip
   );
  }
  setContent() {
   const t = this.getTipElement();
 ...
 class Ut extends q {
  ...
  _transitionComplete(t, e, s) {
   ...
   if (
    ...
    e &&
     i.find('.dropdown-toggle', e).forEach((t) => t.classList.add('active')),
