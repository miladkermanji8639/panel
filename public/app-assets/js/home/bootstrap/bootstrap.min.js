   ...
   return (
    ...
    (t._jQueryInterface = function (e) {
     return this.each(function () {
      ...
      if (
       (n || ((n = new t(this, i)), o.default(this).data('bs.carousel', n)),
       'number' == typeof e)
      )
       n.to(e);
        ...
        for (var a = 0; a < i; a++) {
         ...
         if (null !== l)
          o
           ...
           .hasClass('show') ||
           o.default(s).addClass('collapsed').attr('aria-expanded', !1);
        }
       this.setTransitioning(!0);
       this._element.style[n] = '';
    ...
    (i._jQueryInterface = function (t) {
     return this.each(function () {
      ...
      if (
       ...
       (e || ((e = new i(this, n)), o.default(this).data('bs.popover', e)),
       'string' == typeof t)
      ) {
    ...
    (t._jQueryInterface = function (e) {
     return this.each(function () {
      var n = o.default(this),
       i = n.data('bs.tab');
      if (
       (i || ((i = new t(this)), n.data('bs.tab', i)), 'string' == typeof e)
      ) {
       if ('undefined' == typeof i[e])
        throw new TypeError('No method named "' + e + '"');
       i[e]();
   ...
   return (
    ...
    (t._jQueryInterface = function (e) {
     return this.each(function () {
      ...
      if (
       (i ||
        ((i = new t(this, 'object' == typeof e && e)), n.data('bs.toast', i)),
       'string' == typeof e)
      ) {
       if ('undefined' == typeof i[e])
        throw new TypeError('No method named "' + e + '"');
