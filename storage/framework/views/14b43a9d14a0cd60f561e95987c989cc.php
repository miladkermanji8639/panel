...
[$__name, $__params] = $__split('admin.dashboard.menu.menu-form');

$__html = app('livewire')->mount($__name, $__params, 'lw-2386054164-0', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('admin.content.layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/admin/content/dashboard/menu/create.blade.php ENDPATH**/ ?>