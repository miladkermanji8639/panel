<div>
 <div class="container-fluid py-4">
  ...
  <header class="glass-header p-3 rounded-3 mb-4 shadow-lg animate__fadeIn">
   ...
   <div>
    <a href="<?php echo e(route('admin.content.doctors.comment-doctor.index')); ?>" class="btn btn-light">بازگشت</a>
   </div>
   </div>
  </header>
  <!-- بدنه اصلی -->
    ...
    <div class="card h-100 shadow-lg border-0 animate__fadeInLeft">
     ...
     <div class="card-body p-4">
      <form wire:submit.prevent="updateComment" class="needs-validation" novalidate>
       <input type="hidden" wire:model="commentId" value="<?php echo e($comment->id); ?>">
       <div class="mb-3">
       ...
       <div class="mb-3">
        ...
        <p class="mb-0 text-secondary"><?php echo e($comment->ip_address ?? 'ندارد'); ?></p>
       </div>
       <div class="mb-3">
        <label class="form-label fw-bold text-muted">تاریخ ارسال:</label>
        <p class="mb-0 text-secondary">
         <?php echo e(\Morilog\Jalali\Jalalian::fromCarbon(\Carbon\Carbon::parse($comment->created_at))->format('Y/m/d H:i')); ?>

        </p>
       </div>
       <div class="mb-3">
        <label class="form-label fw-bold text-muted">نام کاربر:</label>
        <p class="mb-0 text-secondary"><?php echo e($comment->user_name); ?> <!--[if BLOCK]><![endif]--><?php if($comment->user_phone): ?>
          -
          <?php echo e($comment->user_phone); ?>
       ...
       <div class="mb-3">
        ...
        <p class="mb-0 text-secondary">
         <?php echo e($comment->doctor->first_name . ' ' . $comment->doctor->last_name); ?>
       ...
       <div class="mb-3">
        ...
        <textarea wire:model="commentText" class="form-control form-control-lg" style="height:150px"
         placeholder="متن نظر را وارد کنید" required><?php echo e($commentText); ?></textarea>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
       ...
       <div class="mb-3">
        ...
        <select wire:model="commentStatus" class="form-select form-select-lg" required>
         <option value="0" <?php echo e($commentStatus == 0 ? 'selected' : ''); ?>>غیرفعال</option>
         <option value="1" <?php echo e($commentStatus == 1 ? 'selected' : ''); ?>>فعال</option>
        </select>
        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['commentStatus'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
            ...
            <form wire:submit.prevent="addReply" class="needs-validation" novalidate>
                ...
                <div class="mb-3">
                    ...
                    <textarea wire:model="replyText" class="form-control form-control-lg" style="height: 150px"
                        placeholder="متن پاسخ را وارد کنید" required><?php echo e($replyText); ?></textarea>
                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['replyText'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <!--[if BLOCK]><![endif]--><?php if($comment->reply): ?>
                <div class="mt-3 p-3 bg-light rounded">
                    <label class="form-label fw-bold text-muted">پاسخ ثبت‌شده:</label>
                    <p class="mb-0 text-secondary"><?php echo e($comment->reply); ?></p>
                </div>
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        </div>
    </div>
...
<?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/admin/doctors/comment-doctor/admin-doctors-comment-show.blade.php ENDPATH**/ ?>