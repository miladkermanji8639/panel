<?php $__env->startSection('title', 'درخواست های تسویه حساب کیف پول بیمارستان    '); ?>
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/assets/js/dashboards-crm.js']); ?>
      ...
      <div class="content-wrapper">
        ...
        <div class="flex-grow-1  container-fluid">
          ...
          <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">   درخواست های تسویه حساب کیف پول بیمارستان  /</span>
          </h4>


          <div class="card">
            <div class="card-header">
              <h5 class="card-title mb-0">لیست  درخواست های تسویه حساب کیف پول بیمارستان  </h5>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              ...
                              <a class="dropdown-item" onclick="location.href='<?php echo e(route('admin.doctors.order-visit.show')); ?>'"
...
<?php echo $__env->make('admin.content.layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/admin/content/hospitals/wallet-hospital-request/index.blade.php ENDPATH**/ ?>