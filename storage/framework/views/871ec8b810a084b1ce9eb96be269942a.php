<div class="container-fluid py-2">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 bg-light p-3 rounded-3 shadow-sm">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <button onclick="confirmDeleteSelected()"
                    ...
                    <?php if(empty($selectedQuestions)): ?> disabled <?php endif; ?>>
    ...
    <div class="container px-0">
        <div class="row g-3">
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="col-12">
                        ...
                        <div class="card-body p-4 d-flex align-items-center justify-content-between gap-3 flex-wrap">
                            <div class="d-flex align-items-center gap-3">
                                <input type="checkbox" class="form-check-input flex-shrink-0 shadow-sm"
                                    wire:model.live="selectedQuestions" value="<?php echo e($question->id); ?>">
                                <div class="flex-grow-1">
                                    <h6 class="mb-1 fw-semibold text-dark"><?php echo e(Str::limit($question->title, 50)); ?></h6>
                                    <small class="text-muted d-block"><?php echo e($question->persian_date); ?> - <?php echo e($question->category->name); ?></small>
                                </div>
                            </div>
                            <div class="text-muted mb-0 text-ellipsis flex-grow-1" style="max-width: 40%;">
                                <?php echo e(Str::limit($question->question, 150)); ?>

                            </div>
                            <div class="d-flex align-items-center gap-3">
                                <span class="badge bg-info-subtle text-info fw-medium px-3 py-2 rounded-pill">
                                    <?php echo e($question->asker_name); ?>

                                </span>
                                <span class="badge bg-warning-subtle text-warning fw-medium px-3 py-2 rounded-pill">
                                    <?php echo e($question->replier_name ?? 'بدون پاسخ‌دهنده'); ?>

                                </span>
                                <div class="form-check form-switch">
                                    <input type="checkbox" class="form-check-input shadow-sm"
                                        wire:model="questionStatuses.<?php echo e($question->id); ?>"
                                        wire:click="toggleStatus(<?php echo e($question->id); ?>)"
                                        id="status-<?php echo e($question->id); ?>"
                                        <?php echo e($questionStatuses[$question->id] ? 'checked' : ''); ?>>
                                    <label class="form-check-label text-muted fw-medium mx-2" for="status-<?php echo e($question->id); ?>">
                                        <?php echo e($questionStatuses[$question->id] ? 'منتشر شده' : 'منتشر نشده'); ?>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end shadow-sm rounded-3">
                                        <a class="dropdown-item d-flex align-items-center gap-2"
                                            href="<?php echo e(route('admin.questions.question.show', $question->id)); ?>">
...
</div><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/admin/questions/question-list.blade.php ENDPATH**/ ?>