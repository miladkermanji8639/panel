<div>
    ...
    <!--[if BLOCK]><![endif]--><?php if($successMessage): ?>
        ...
        <script>
            setTimeout(function () {
                window.location.href = "<?php echo e(route('admin.Dashboard.usershipfee.index')); ?>";
            }, 5000);
        </script>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="col-12 mt-4">
                        ...
                        <a href="<?php echo e(route('admin.Dashboard.usershipfee.index')); ?>"
...
</div><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/admin/dashboard/usership/usership-fee-edit.blade.php ENDPATH**/ ?>