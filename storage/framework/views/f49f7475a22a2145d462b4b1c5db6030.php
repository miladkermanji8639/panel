...
<head>
 ...
 <link rel="stylesheet" href="<?php echo e(asset('dr-assets/panel/css/bootstrap.min.css')); ?>">
 <link rel="stylesheet" href="<?php echo e(asset('dr-assets/panel/css/style.css')); ?>">
 ...
 <link rel="stylesheet" href="<?php echo e(asset('dr-assets/panel/css/doctors-clininc/activation/index.css')); ?>">
 <link rel="stylesheet" href="<?php echo e(asset('dr-asset/panel/css/toastify/toastify.min.css')); ?>">
 <link rel="stylesheet" href="<?php echo e(asset('dr-assets/panel/css/toastr/toastr.min.css')); ?>">
 <link rel="stylesheet" href="<?php echo e(asset('dr-assets/panel/css/leaflet/leaflet.css')); ?>">
...
<body>
 ...
 <header class="bg-light text-dark p-3 my-shodow w-100 d-flex align-items-center">
  <div class="back w-50">
   <a href="<?php echo e(route('dr-panel')); ?>" class="btn btn-light">
     ...
     <div class="card  shadow">
      <div class="card-body">
       ...
       <div class="input-group mt-2">
        <input type="text" value="<?php echo e($clinic->address ?? ''); ?>" class="my-form-control w-100"
 ...
 <script src="<?php echo e(asset('dr-asset/panel/js/toastify/toastify.min.js')); ?>"></script>
 <script src="<?php echo e(asset('dr-assets/panel/js/sweetalert2/sweetalert2.js')); ?>"></script>
 <script src="<?php echo e(asset('dr-assets/panel/js/leaflet/leaflet.js')); ?>"></script>
 <script src="<?php echo e(asset('dr-assets/panel/js/leaflet/leaflet-control-geocoder/dist/Control.Geocoder.js')); ?>"></script>
 <script src="<?php echo e(asset('dr-assets/panel/js/toastr/toastr.min.js')); ?>"></script>

 <script>
  const clinicId = <?php echo e($clinic->id); ?>;
  const updateAddressUrl = "<?php echo e(route('doctors.clinic.update.address', ['id' => $clinic->id])); ?>";
   ...
   if (index !== null) {
    Swal.fire({
     ...
     if (result.isConfirmed) {
      $.ajax({
       url: "<?php echo e(route('doctors.clinic.delete.phone', ['id' => $clinic->id])); ?>",
       type: 'POST',
       data: {
  ...
  $('#doneModal').on('show.bs.modal', function() {
   ...
   $.ajax({
    url: "<?php echo e(route('doctors.clinic.get.phones', ['id' => $clinic->id])); ?>",
    type: 'GET',
    success: function(response) {
  ...
  $('#phoneForm').on('submit', function(e) {
   ...
   $.ajax({
    url: "<?php echo e(route('doctors.clinic.update.phones', ['id' => $clinic->id])); ?>",
    type: 'POST',
    data: formData,
    success: function(response) {
     buttonText.show();
     ...
     location.href = "<?php echo e(route('doctors.clinic.cost', $clinic->id)); ?>"
    },
    error: function() {
     buttonText.show();
     loader.hide();
...
<?php /**PATH D:\MyProjects\Benobe\panel\resources\views/dr/panel/doctors-clinic/activation/index.blade.php ENDPATH**/ ?>