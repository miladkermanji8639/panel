...
<header class="bg-light text-dark p-3 my-shodow w-100 d-flex align-items-center">
  <div class="back w-50">
    <a href="<?php echo e(route('doctors.clinic.cost', $clinicId)); ?>" class="btn btn-light">
...
<script>
  document.addEventListener("DOMContentLoaded", function () {
    ...
    `;
        ...
        try {
          const response = await fetch("<?php echo e(route('duration.store')); ?>", {
            method: "POST",
          ...
          if (data.success) {
            ...
            location.href = "<?php echo e(route('activation.workhours.index', $clinicId)); ?>";
          } else {
...
c<?php /**PATH D:\MyProjects\Benobe\panel\resources\views/dr/panel/doctors-clinic/activation/duration/index.blade.php ENDPATH**/ ?>