<div class="container-fluid py-5">
    ...
    <header class="glass-header p-4 rounded-3 mb-5 shadow-lg">
        <div class="d-flex align-items-center gap-3">
            ...
            <h4 class="mb-0 fw-bold text-white">ویرایش صفحه</h4>
        </div>
    </header>
    ...
    <div class="container px-0">
        <div class="card border-0 rounded-3 shadow-md bg-gradient-card">
            <div class="card-header bg-gradient-primary text-white p-4 rounded-top-3">
                <h5 class="mb-0 fw-bold">ویرایش صفحه</h5>
            </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <label class="fw-semibold text-dark mb-2 d-flex align-items-center gap-2">
                                <i class="fas fa-link text-muted"></i> آدرس صفحه (URL)
                            </label>
                            <input type="text" class="form-control shadow-sm border-0 bg-white" wire:model="page_url"
                                dir="ltr">
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['page_url'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="col-md-6">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($existingImage): ?>
                                <div class="mb-2">
                                    <img src="<?php echo e(asset('storage/' . $existingImage)); ?>" class="img-thumbnail"
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="col-md-6">
                            <label class="fw-semibold text-dark mb-2 d-flex align-items-center gap-2">
                                <i class="fas fa-file-code text-muted"></i> قالب جداگانه (.tpl)
                            </label>
                            <input type="text" class="form-control shadow-sm border-0 bg-white text-left" dir="ltr"
                                wire:model="tplname" placeholder="مثال: custom.tpl">
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['tplname'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger d-block mt-1"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="col-12">
                            <label class="fw-semibold text-dark mb-2 d-flex align-items-center gap-2">
                                <i class="fas fa-align-justify text-muted"></i> توضیحات کوتاه
                            </label>
                            <textarea class="form-control shadow-sm border-0 bg-white" wire:model="lead"
                                rows="3"></textarea>
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['lead'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger d-block mt-1"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="col-12">
                            <label class="fw-semibold text-dark mb-2 d-flex align-items-center gap-2">
                                <i class="fas fa-align-justify text-muted"></i> توضیحات کامل
                            </label>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label text-muted fw-medium mx-2" for="approveSwitch">
                                    <?php echo e($approve ? 'فعال' : 'غیرفعال'); ?>

                                </label>
                            </div>
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['approve'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger d-block mt-1"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="col-12 d-flex justify-content-between align-items-center gap-3 mt-4">
                            <a href="<?php echo e(route('admin.content-management.front-pages.index')); ?>"
...
</div><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/admin/content-management/front-page-edit.blade.php ENDPATH**/ ?>