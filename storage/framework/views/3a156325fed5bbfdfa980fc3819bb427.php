<div class="container-fluid py-4">
    ...
    <div class="bg-light text-dark p-4 rounded-top border">
        <div class="d-flex align-items-center justify-content-between">
            ...
            <a href="<?php echo e(route('admin.Dashboard.setting.index')); ?>" class="btn btn-outline-primary">
                ...
                <div class="p-3 border rounded bg-light">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($currentLogo): ?>
                        <div class="mt-3 text-center">
                            <img src="<?php echo e(Storage::url($currentLogo->path)); ?>" class="img-thumbnail" width="200"
                                alt="لوگوی فعلی">
...
</div><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/admin/dashboard/system-setting/change-logo-component.blade.php ENDPATH**/ ?>