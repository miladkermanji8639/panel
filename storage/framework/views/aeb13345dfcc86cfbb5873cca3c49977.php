  ...
  <div class="col-12 col-xl-8 mb-4">
   <div class="card">
    <div class="card-header d-flex justify-content-between">
     ...
     <div class="dropdown">
      <button aria-expanded="false" aria-haspopup="true" class="btn p-0" data-bs-toggle="dropdown"
       id="earningReportsTabsId" type="button">
    ...
    <div class="card-body">
     <ul class="nav nav-tabs widget-nav-tabs pb-3 gap-4 mx-1 d-flex flex-nowrap" role="tablist">
      <li class="nav-item">
       <a aria-controls="navs-orders-id" aria-selected="true"
        class="nav-link btn active d-flex flex-column align-items-center justify-content-center"
        data-bs-target="#navs-orders-id" data-bs-toggle="tab" href="javascript:void(0);" role="tab">
      ...
      <li class="nav-item">
       <a aria-controls="navs-sales-id" aria-selected="false"
        class="nav-link btn d-flex flex-column align-items-center justify-content-center"
        data-bs-target="#navs-sales-id" data-bs-toggle="tab" href="javascript:void(0);" role="tab">
        <div class="badge bg-label-secondary rounded p-2">
      ...
      <li class="nav-item">
       <a aria-controls="navs-profit-id" aria-selected="false"
        class="nav-link btn d-flex flex-column align-items-center justify-content-center"
        data-bs-target="#navs-profit-id" data-bs-toggle="tab" href="javascript:void(0);" role="tab">
        <div class="badge bg-label-secondary rounded p-2">
      ...
      <li class="nav-item">
       <a aria-controls="navs-income-id" aria-selected="false"
        class="nav-link btn d-flex flex-column align-items-center justify-content-center"
        data-bs-target="#navs-income-id" data-bs-toggle="tab" href="javascript:void(0);" role="tab">
        <div class="badge bg-label-secondary rounded p-2">
      ...
      <li class="nav-item">
       <a aria-selected="false" class="nav-link btn d-flex align-items-center justify-content-center disabled"
  ...
  <div class="col-md-6 col-xl-4 mb-4">
   <div class="card h-100">
    <div class="card-header d-flex justify-content-between">
     ...
     <div class="dropdown">
      <button aria-expanded="false" aria-haspopup="true" class="btn p-0" data-bs-toggle="dropdown"
       id="salesLastMonthMenu" type="button">
       <i class="ti ti-dots-vertical ti-sm text-muted"></i>
      </button>
  ...
  <div class="col-xl-4 col-md-6 mb-4">
   <div class="card h-100">
    <div class="card-header d-flex justify-content-between">
     ...
     <div class="dropdown">
      <button aria-expanded="false" aria-haspopup="true" class="btn p-0" data-bs-toggle="dropdown" id="employeeList"
       type="button">
       <i class="ti ti-dots-vertical ti-sm text-muted"></i>
      </button>
    ...
    <div class="card-body">
     <ul class="p-0 m-0">
      <li class="d-flex mb-4 pb-2 align-items-center">
       <img alt="کروم" class="me-3 rounded" height="28"
        src="<?php echo e(asset('assets/img/icons/brands/chrome.png')); ?>" />
      ...
      <li class="d-flex mb-4 pb-2 align-items-center">
       <img alt="سياحت اکتشافی" class="me-3 rounded" height="28"
        src="<?php echo e(asset('assets/img/icons/brands/safari.png')); ?>" />
       <div class="d-flex w-100 align-items-center gap-2">
        <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
         <div>
      ...
      <li class="d-flex mb-4 pb-2 align-items-center">
       <img alt="فایرفاکس" class="me-3 rounded" height="28"
        src="<?php echo e(asset('assets/img/icons/brands/firefox.png')); ?>" />
       <div class="d-flex w-100 align-items-center gap-2">
        <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
         <div>
      ...
      <li class="d-flex mb-4 pb-2 align-items-center">
       <img alt="اپرا" class="me-3 rounded" height="28"
        src="<?php echo e(asset('assets/img/icons/brands/opera.png')); ?>" />
       <div class="d-flex w-100 align-items-center gap-2">
        <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
         <div>
      ...
      <li class="d-flex mb-4 pb-2 align-items-center">
       <img alt="لبه" class="me-3 rounded" height="28"
        src="<?php echo e(asset('assets/img/icons/brands/edge.png')); ?>" />
       <div class="d-flex w-100 align-items-center gap-2">
        <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
         <div>
      ...
      <li class="d-flex align-items-center">
       <img alt="شجاع" class="me-3 rounded" height="28"
        src="<?php echo e(asset('assets/img/icons/brands/brave.png')); ?>" />
       <div class="d-flex w-100 align-items-center gap-2">
        <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
         <div>
  ...
  <div class="col-12 col-xl-4 mb-4 col-md-6">
   <div class="card">
    <div class="card-header d-flex justify-content-between">
     ...
     <div class="dropdown">
      <button aria-expanded="false" aria-haspopup="true" class="btn p-0" data-bs-toggle="dropdown"
       id="projectStatusId" type="button">
       <i class="ti ti-dots-vertical ti-sm text-muted"></i>
      </button>
     ...
     <ul class="p-0 m-0">
      <li class="mb-3 pb-1 d-flex">
       <div class="d-flex w-50 align-items-center me-3">
        <img alt="آرم لاراول" class="me-3" src="<?php echo e(asset('assets/img/icons/brands/laravel-logo.png')); ?>"
         width="35" />
        <div>
       ...
       <div class="d-flex flex-grow-1 align-items-center">
        <div class="progress w-100 me-3" style="height: 8px">
         <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="54" class="progress-bar bg-danger"
      ...
      <li class="mb-3 pb-1 d-flex">
       <div class="d-flex w-50 align-items-center me-3">
        <img alt="لوگوی فیگما" class="me-3" src="<?php echo e(asset('assets/img/icons/brands/figma-logo.png')); ?>"
         width="35" />
        <div>
       ...
       <div class="d-flex flex-grow-1 align-items-center">
        <div class="progress w-100 me-3" style="height: 8px">
         <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="86" class="progress-bar bg-primary"
          role="progressbar" style="width: 86%"></div>
        </div>
      ...
      <li class="mb-3 pb-1 d-flex">
       <div class="d-flex w-50 align-items-center me-3">
        <img alt="لوگوی وو" class="me-3" src="<?php echo e(asset('assets/img/icons/brands/vue-logo.png')); ?>"
         width="35" />
        <div>
      ...
      <li class="mb-3 pb-1 d-flex">
       <div class="d-flex w-50 align-items-center me-3">
        <img alt="آرم راکت" class="me-3" src="<?php echo e(asset('assets/img/icons/brands/react-logo.png')); ?>"
         width="35" />
        <div>
      ...
      <li class="mb-3 pb-1 d-flex">
       <div class="d-flex w-50 align-items-center me-3">
        <img alt="آرم بوت استرپ" class="me-3" src="<?php echo e(asset('assets/img/icons/brands/bootstrap-logo.png')); ?>"
         width="35" />
        <div>
       ...
       <div class="d-flex flex-grow-1 align-items-center">
        <div class="progress w-100 me-3" style="height: 8px">
         <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="22" class="progress-bar bg-primary"
          role="progressbar" style="width: 22%"></div>
        </div>
      ...
      <li class="d-flex">
       <div class="d-flex w-50 align-items-center me-3">
        <img alt="لوگوی طرح" class="me-3" src="<?php echo e(asset('assets/img/icons/brands/sketch-logo.png')); ?>"
         width="35" />
        <div>
       ...
       <div class="d-flex flex-grow-1 align-items-center">
        <div class="progress w-100 me-3" style="height: 8px">
         <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="29" class="progress-bar bg-warning"
          role="progressbar" style="width: 29%"></div>
        </div>
      ...
      <tbody>
       <tr>
        <td>
         <div class="d-flex justify-content-start align-items-center">
          <div class="me-3">
           <img alt="ویزا" height="30" src="<?php echo e(asset('assets/img/icons/payments/visa-img.png')); ?>" />
          </div>
          <div class="d-flex flex-column">
       ...
       <tr>
        <td>
         <div class="d-flex justify-content-start align-items-center">
          <div class="me-3">
           <img alt="ویزا" height="30" src="<?php echo e(asset('assets/img/icons/payments/master-card-img.png')); ?>" />
          </div>
          <div class="d-flex flex-column">
           <p class="mb-0 fw-medium">
            <bdi>*5578</bdi>
       ...
       <tr>
        <td>
         <div class="d-flex justify-content-start align-items-center">
          <div class="me-3">
           <img alt="ویزا" height="30"
            src="<?php echo e(asset('assets/img/icons/payments/american-express-img.png')); ?>" />
          </div>
          <div class="d-flex flex-column">
           <p class="mb-0 fw-medium">
            <bdi>*4567</bdi>
       ...
       <div class="timeline-event">
        ...
        <div class="d-flex flex-wrap">
         <div class="avatar me-2">
          <img alt="آواتار" class="rounded-circle" src="<?php echo e(asset('assets/img/avatars/3.png')); ?>" />
         </div>
         <div class="ms-1">
...
<?php echo $__env->make('admin.content.layouts.layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/admin/content/dashboard/index.blade.php ENDPATH**/ ?>