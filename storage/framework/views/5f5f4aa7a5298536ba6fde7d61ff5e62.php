<div class="container-fluid py-4">
    ...
    <div class="bg-light text-dark p-4 rounded-top border">
        <div class="d-flex align-items-center justify-content-between">
            ...
            <a href="<?php echo e(route('admin.content-management.slide.create')); ?>" class="btn btn-primary">
    ...
    <div class="bg-white p-4 rounded-bottom shadow-sm">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <button class="btn btn-danger" id="delete-selected-btn" <?php if(empty($selectedSlides)): ?> disabled <?php endif; ?>>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td>
                                <input type="checkbox" class="form-check-input" wire:model.live="selectedSlides"
                                    value="<?php echo e($slide->id); ?>">
                            </td>
                            <td><?php echo e($slides->firstItem() + $index); ?></td>
                            <td>
                                <!--[if BLOCK]><![endif]--><?php if($slide->image): ?>
                            ...
                            <td><?php echo e($slide->display === 'site' ? 'سایت' : 'موبایل'); ?></td>
                            <td>
                                <div class="form-check form-switch">
                                    <input type="checkbox" class="form-check-input"
                                        wire:model.live="slideStatuses.<?php echo e($slide->id); ?>"
                                        wire:change="toggleStatus(<?php echo e($slide->id); ?>)" <?php if($slide->status): echo 'checked'; endif; ?>>
                                    <label class="form-check-label mx-1"><?php echo e($slide->status ? 'فعال' : 'غیرفعال'); ?></label>
                                </div>
                            </td>
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item"
                                            href="<?php echo e(route('admin.content-management.slide.edit', $slide->id)); ?>">
...
</div><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/admin/content-management/slide-list.blade.php ENDPATH**/ ?>