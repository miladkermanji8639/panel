            ...
            <div class="card-body p-5">
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <p class="text-muted mb-0 bg-white p-2 rounded-2 shadow-sm"><?php echo e($persian_date); ?></p>
                    </div>
                    <div class="col-md-6">
                        <label class="fw-semibold text-dark mb-2 d-flex align-items-center gap-2">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="col-md-6">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['asker_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger d-block mt-1"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control shadow-sm border-0 bg-white" wire:model="asker_phone"
                            dir="ltr">
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['asker_phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger d-block mt-1"><?php echo e($message); ?></span> <?php unset($message);
                ...
                <form wire:submit.prevent="save">
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['replier_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger d-block mt-1"><?php echo e($message); ?></span> <?php unset($message);
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label text-muted fw-medium mx-2" for="approveSwitch">
                                    <?php echo e($approve ? 'منتشر شده' : 'منتشر نشده'); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control shadow-sm border-0 bg-white" wire:model="reply" rows="10"
                                id="reply"></textarea>
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['reply'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger d-block mt-1"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="col-12 d-flex justify-content-between align-items-center gap-3 mt-4">
                            <a href="<?php echo e(route('admin.questions.question.index')); ?>"
...
</div><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/admin/questions/question-show.blade.php ENDPATH**/ ?>