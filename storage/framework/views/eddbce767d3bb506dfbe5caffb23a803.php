...
<?php $__env->startSection('bread-crumb-title', 'برنامه ریزی مشاوره آنلاین'); ?>
...
<?php $component = App\View\Components\MyToggleAppointment::resolve(['isChecked' => $appointmentConfig->auto_scheduling,'id' => 'appointment-toggle','day' => 'مشاوره آنلاین'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
    ...
    <div>
     <div>
      <div class="input-group position-relative">
       ...
       <input type="number" value="<?php echo e($appointmentConfig->calendar_days ?? ''); ?>" class="form-control text-center h-50 border-radius-0" name="calendar_days"
  ...
  چنانچه از ۱۰ دقیقه مشاوره 6 دقیقه مکالمه انجام شود مبلغ پورسانت سایت بصورت کامل برداشت میشود">
      ...
      <div class="col-md-6">
       <div class="input-group position-relative">
        ...
        <input type="tel" value="<?php echo e(explode(".", $appointmentConfig->price_15min)[0]); ?>" class="form-control numberkey ltr text-center h-50 border-radius-0"
         name="call_15min_1">
      ...
      <div class="col-md-6 therty-min-768">
       <div class="input-group position-relative">
        ...
        <input type="tel" value="<?php echo e(explode(".", $appointmentConfig->price_30min)[0]); ?>" class="form-control numberkey ltr text-center h-50 border-radius-0"
         name="call_15min_2">
        <div class="input-group-append"><span class="input-group-text">تومان</span></div>
       </div>
      </div>
      ...
      <div class="col-md-6">
       <div class="input-group position-relative">
        ...
        <input type="tel" value="<?php echo e(explode(".", $appointmentConfig->price_45min)[0]); ?>" class="form-control numberkey ltr text-center h-50 border-radius-0"
         name="call_15min_3">
        <div class="input-group-append"><span class="input-group-text">تومان</span></div>
       </div>
      </div>
      <div class="col-md-6 sixty-min-768">
       <div class="input-group position-relative">
        ...
        <input type="tel" value="<?php echo e(explode(".", $appointmentConfig->price_60min)[0]); ?>" class="form-control numberkey ltr text-center h-50 border-radius-0"
         name="call_15min_4">
        <div class="input-group-append"><span class="input-group-text">تومان</span></div>
       </div>
      </div>
...
<?php endif; ?>
     ...
     <div class="mt-3">
      <?php if (isset($component)) { $__componentOriginalc4103c6e05d4a2d8ea880e1f9551cc17 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc4103c6e05d4a2d8ea880e1f9551cc17 = $attributes; } ?>
<?php $component = App\View\Components\MyCheck::resolve(['isChecked' => $appointmentConfig->holiday_availability,'id' => 'posible-appointments-inholiday','day' => 'مشاوره آنلاین تعطیلات رسمی'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('my-check'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
  ...
  <?php echo $__env->make('dr.panel.my-tools.counseling', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('dr.panel.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/dr/panel/turn/schedule/moshavere_setting/index.blade.php ENDPATH**/ ?>