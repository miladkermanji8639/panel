<div class="container-fluid py-4">
    ...
    <div class="bg-light text-dark p-4 rounded-top border">
        <div class="d-flex align-items-center">
            ...
            <h5 class="mb-0 fw-bold">ویرایش خبر</h5>
        </div>
    </div>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            // مقدار اولیه تاریخ جلالی
            const initialDate = <?php echo json_encode($this->selectedDate, 15, 512) ?>;
            ...
            flatpickr("#date-picker", {
                ...
                locale: {
                    ...
                    months: {
                        shorthand: persianMonths,
                        longhand: persianMonths
                    }
                },
...
</div><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/admin/content-management/blog-edit.blade.php ENDPATH**/ ?>