<div class="container-fluid py-2">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 bg-light p-3 rounded-3 shadow-sm">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <button onclick="confirmDeleteSelected()"
                    ...
                    <?php if(empty($selectedVideos)): ?> disabled <?php endif; ?>>
                    <i class="fas fa-trash fs-6"></i> حذف انتخاب‌شده‌ها
                </button>
                <a href="<?php echo e(route('admin.content-management.home-video.create')); ?>"
    ...
    <div class="container px-0">
        <div class="row g-3">
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="col-12">
                        ...
                        <div class="card-body p-4 d-flex align-items-center justify-content-between gap-3 flex-wrap">
                            <div class="d-flex align-items-center gap-3">
                                <input type="checkbox" class="form-check-input flex-shrink-0 shadow-sm"
                                    wire:model.live="selectedVideos" value="<?php echo e($video->id); ?>">
                                <!--[if BLOCK]><![endif]--><?php if($video->image): ?>
                                    <img src="<?php echo e(asset('storage/' . $video->image)); ?>" class="img-thumbnail"
                                        style="width: 85px; height: auto; cursor: pointer;" data-bs-toggle="modal"
                                        data-bs-target="#videoModal-<?php echo e($video->id); ?>">
                                <?php else: ?>
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="mb-1 fw-semibold text-dark"><?php echo e($video->title); ?></h6>
                                </div>
                            </div>
                            <div class="d-flex align-items-center gap-3">
                                <!--[if BLOCK]><![endif]--><?php if($video->video): ?>
                                    <span class="badge bg-info-subtle text-info fw-medium px-3 py-2 rounded-pill cursor-pointer"
                                        data-bs-toggle="modal" data-bs-target="#videoModal-<?php echo e($video->id); ?>">
                                        ویدئو بارگذاری شده
                                    </span>
                                <?php else: ?>
                                ...
                                <div class="form-check form-switch">
                                    <input type="checkbox" class="form-check-input shadow-sm"
                                        wire:model.live="videoStatuses.<?php echo e($video->id); ?>"
                                        wire:change="toggleStatus(<?php echo e($video->id); ?>)" id="status-<?php echo e($video->id); ?>">
                                    <label class="form-check-label text-muted fw-medium mx-2" for="status-<?php echo e($video->id); ?>">
                                        <?php echo e($videoStatuses[$video->id] ? 'فعال' : 'غیرفعال'); ?>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end shadow-sm rounded-3">
                                        <a class="dropdown-item d-flex align-items-center gap-2"
                                            href="<?php echo e(route('admin.content-management.home-video.edit', $video->id)); ?>">
                ...
                <div class="modal fade" id="videoModal-<?php echo e($video->id); ?>" tabindex="-1"
                    aria-labelledby="videoModalLabel-<?php echo e($video->id); ?>" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content bg-gradient-card border-0 shadow-lg">
                            <div class="modal-header bg-gradient-primary text-white border-0">
                                <h5 class="modal-title fw-bold" id="videoModalLabel-<?php echo e($video->id); ?>"><?php echo e($video->title); ?>
        ...
        <div class="mt-5 d-flex justify-content-center">
            <?php echo e($videos->links('pagination::bootstrap-5')); ?>
...
</div><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/admin/content-management/home-video-list.blade.php ENDPATH**/ ?>