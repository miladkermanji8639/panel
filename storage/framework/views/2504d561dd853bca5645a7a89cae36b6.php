...
<script>
 function updateAlert() {
  fetch("<?php echo e(route('dr-check-profile-completeness')); ?>", {
    method: 'GET',
    headers: {
               ...
               <div class="w-100">
                 ...
                 <select name="degrees[${inputCount}]" id="degree${inputCount}" class="form-control h-50 w-100 border-radius-6 mt-3 col-12 position-relative daraje">
                   <?php $__currentLoopData = $academic_degrees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $academic_degree): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <option value="<?php echo e($academic_degree->id); ?>"><?php echo e($academic_degree->title); ?></option>
               ...
               <div class="w-100">
                 ...
                 <select name="specialties[${inputCount}]" id="specialty${inputCount}" class="form-control h-50 w-100 border-radius-6 mt-3 col-12 position-relative takhasos-input">
                   <?php $__currentLoopData = $sub_specialties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specialtyOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <option value="<?php echo e($specialtyOption->id); ?>"><?php echo e($specialtyOption->name); ?></option>
                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                 </select>
               </div>
             </div>
 ...
 const deleteSpecialtyRoute = "<?php echo e(route('dr-delete-specialty', ['id' => '__ID__'])); ?>";
                            ...
                            <div class="d-flex justify-content-between gap-4">
                                <div class="w-100">
                                    ...
                                    <select name="degrees[${index}]" id="degree${index + 1}" class="form-control h-50 w-100 border-radius-6 mt-3 col-12 position-relative daraje">
                                        <?php $__currentLoopData = $academic_degrees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $academic_degree): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($academic_degree->id); ?>" ${specialty.academic_degree_id == <?php echo e($academic_degree->id); ?> ? 'selected' : ''}><?php echo e($academic_degree->title); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div class="w-100">
                                    ...
                                    <select name="specialties[${index}]" id="specialty${index + 1}" class="form-control h-50 w-100 border-radius-6 mt-3 col-12 position-relative takhasos-input">
                                        <?php $__currentLoopData = $sub_specialties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specialtyOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($specialtyOption->id); ?>" ${specialty.specialty_id == <?php echo e($specialtyOption->id); ?> ? 'selected' : ''}><?php echo e($specialtyOption->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
 ...
 function sendOtpCode() {
  ...
  $.ajax({
   url: "<?php echo e(route('dr-send-mobile-otp')); ?>",
   method: 'POST',
   data: {
    mobile: newMobile
   },
 ...
 function verifyOtpCode() {
  ...
  $.ajax({
   url: `<?php echo e(route('dr-mobile-confirm', '')); ?>/${otpToken}`,
   method: 'POST',
   data: {
 ...
 document.addEventListener('DOMContentLoaded', function() {
  ...
  form.addEventListener('submit', function(e) {
   ...
   loader.style.display = 'block';
   // ارسال درخواست Ajax
   fetch("<?php echo e(route('dr-messengers-update')); ?>", {
     method: 'PUT',
     headers: {
      'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
      'Accept': 'application/json',
 ...
 document.addEventListener('DOMContentLoaded', function() {
  ...
  toggleSwitch.addEventListener('change', function() {
   if (this.checked) {
    ...
    fetch("<?php echo e(route('dr-static-password-update')); ?>", {
      method: 'POST',
      headers: {
       'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
       'Accept': 'application/json',
 ...
 document.addEventListener('DOMContentLoaded', function() {
  ...
  toggleSwitch.addEventListener('change', function() {
   if (this.checked) {
    ...
    fetch("<?php echo e(route('dr-two-factor-update')); ?>", {
      method: 'POST',
      headers: {
       'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
       'Accept': 'application/json',
 ...
 document.addEventListener('DOMContentLoaded', function() {
  const incompleteSections = <?php echo json_encode($doctor->getIncompleteProfileSections(), 15, 512) ?>;
...
<?php /**PATH D:\MyProjects\Benobe\panel\resources\views/dr/panel/profile/option/profile-option.blade.php ENDPATH**/ ?>