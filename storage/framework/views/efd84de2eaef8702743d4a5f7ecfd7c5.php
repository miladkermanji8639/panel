<div class="app-content-body">
 <div class="bg-white-only lter b-b wrapper-md clrfix">
  <h1 class="m-n h3 font-thin">ایجاد تگ</h1>
 </div>
 <div class="wrapper-md">
  <form wire:submit.prevent="save" class="row tagform">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
   ...
   <div class="form-group mt-3">
    ...
    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['usage_count'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
   ...
   <div class="col-md-12">
    ...
    <a href="<?php echo e(route('admin.content-management.tags.index')); ?>" class="btn btn-outline-warning mt-3">
...
<?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/admin/content-management/tags/tag-create.blade.php ENDPATH**/ ?>