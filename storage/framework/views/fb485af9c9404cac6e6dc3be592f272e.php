<?php $__env->startSection('styles'); ?>
 ...
 <link type="text/css" href="<?php echo e(asset('dr-assets/panel/css/turn/schedule/appointments.css')); ?>" rel="stylesheet" />
...
<?php $__env->startSection('bread-crumb-title', 'لیست نوبت ها'); ?>
     ...
     <ul class="d-flex flex-column align-items-center justify-content-center w-100 gap-10">
      ...
      <?php $__currentLoopData = $clinics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clinic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
       <li class="btn border w-100 btn-primary border-radius-4"
        onclick="window.location.href='<?php echo e(route('activation-doctor-clinic', $clinic->id)); ?>'">
        <span>+</span>
        <span>فعالسازی نوبت‌دهی مطب <?php echo e($clinic->name); ?></span>
       </li>
   ...
   <div class="modal-body">
    <div class="">
     ...
     <button class="btn btn-primary h-50 w-100 mt-3" type="button"
      onclick="location.href='<?php echo e(route('prescription.create')); ?>'">
      تجویز نسخه
     </button>
...
<?php echo $__env->make('dr.panel.turn.schedule.option.appointments', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('dr.panel.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/dr/panel/turn/schedule/appointments.blade.php ENDPATH**/ ?>