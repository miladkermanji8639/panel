...
<script src="<?php echo e(asset('admin-assets/typeahead-js/typeahead.js')); ?>"></script>

<?php echo app('Illuminate\Foundation\Vite')(['resources/assets/vendor/libs/popper/popper.js', 'resources/assets/vendor/js/bootstrap.js', 'resources/assets/vendor/libs/node-waves/node-waves.js', 'resources/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js', 'resources/assets/vendor/libs/hammer/hammer.js','resources/assets/vendor/js/menu.js']); ?>
...
<script src="<?php echo e(asset('dr-asset/panel/js/tom-select.complete.min.js')); ?>"></script>
 <script src="<?php echo e(asset('admin-assets/js/select2/select2.min.js')); ?>"></script>
