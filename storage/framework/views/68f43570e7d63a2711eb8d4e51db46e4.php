...
<?php if(isset($navbarFull)): ?>
 <div class="navbar-brand app-brand demo d-none d-xl-flex py-0 me-4">
  <a href="<?php echo e(url('admin/')); ?>" class="app-brand-link gap-2">
   ...
   <div class="dropdown-menu dropdown-menu-end py-0">
    <div class="dropdown-menu-header border-bottom">
     <div class="dropdown-header d-flex align-items-center py-3">
      ...
      <a class="dropdown-shortcuts-add text-body" data-bs-placement="top" data-bs-toggle="tooltip"
       href="javascript:void(0)" title="افزودن میانبر">
    ...
    <div class="dropdown-shortcuts-list scrollable-container">
     <div class="row row-bordered overflow-visible g-0">
      <div class="dropdown-shortcuts-item col">
       ...
       <a class="stretched-link mb-0" href="<?php echo e(route('admin.Dashboard.holiday.index')); ?>">روز های تعطیل سال</a>
      ...
      <div class="dropdown-shortcuts-item col">
       ...
       <a class="stretched-link mb-0" href="<?php echo e(route('admin.content-management.comments.index')); ?>">نظرات کاربران</a>
     ...
     <div class="row row-bordered overflow-visible g-0">
      <div class="dropdown-shortcuts-item col">
       ...
       <a class="stretched-link mb-0" href="<?php echo e(route('admin.content.users-management.users.index')); ?>">کاربران</a>
      ...
      <div class="dropdown-shortcuts-item col">
       ...
       <a class="stretched-link mb-0" href="<?php echo e(route('admin.content.hospitals.hospitals-management.index')); ?>">
        بیمارستان</a>
     ...
     <div class="row row-bordered overflow-visible g-0">
      <div class="dropdown-shortcuts-item col">
       ...
       <a class="stretched-link mb-0" href="<?php echo e(route('admin.index')); ?>">داشبورد</a>
      ...
      <div class="dropdown-shortcuts-item col">
       ...
       <a class="stretched-link mb-0" href="<?php echo e(route('admin.Dashboard.setting.index')); ?>">تنظیمات</a>
     ...
     <div class="row row-bordered overflow-visible g-0">
      <div class="dropdown-shortcuts-item col">
       ...
       <a class="stretched-link mb-0" href="<?php echo e(url('admin/pages/faq')); ?>">مرکز پشتیبانی</a>
      ...
      <div class="dropdown-shortcuts-item col">
       ...
       <a class="stretched-link mb-0" href="<?php echo e(url('admin/modal-examples')); ?>">مُـدال‌ها</a>
     ...
     <ul class="list-group list-group-flush">
      <li class="list-group-item list-group-item-action dropdown-notifications-item">
       <div class="d-flex">
        <div class="flex-shrink-0 me-3">
         <div class="avatar">
          <img alt class="h-auto rounded-circle" src="<?php echo e(asset('dr-assets/panel/img/pro.jpg')); ?>" />
         </div>
        </div>
      ...
      <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
       <div class="d-flex">
        <div class="flex-shrink-0 me-3">
         <div class="avatar">
          <img alt class="h-auto rounded-circle" src="<?php echo e(asset('assets/img/avatars/2.png')); ?>" />
         </div>
        </div>
        <div class="flex-grow-1">
      ...
      <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
       <div class="d-flex">
        <div class="flex-shrink-0 me-3">
         <div class="avatar">
          <img alt class="h-auto rounded-circle" src="<?php echo e(asset('assets/img/avatars/9.png')); ?>" />
         </div>
        </div>
        <div class="flex-grow-1">
      ...
      <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
       <div class="d-flex">
        <div class="flex-shrink-0 me-3">
         <div class="avatar">
          <img alt class="h-auto rounded-circle" src="<?php echo e(asset('assets/img/avatars/5.png')); ?>" />
         </div>
        </div>
        <div class="flex-grow-1">
      ...
      <li class="list-group-item list-group-item-action dropdown-notifications-item">
       <div class="d-flex">
        <div class="flex-shrink-0 me-3">
         <div class="avatar">
          <img alt class="h-auto rounded-circle" src="<?php echo e(asset('assets/img/avatars/6.png')); ?> " />
         </div>
        </div>
        <div class="flex-grow-1">
  ...
  <li class="nav-item navbar-dropdown dropdown-user dropdown">
   <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
    <div class="avatar avatar-online">
     <img src="<?php echo e(asset('dr-assets/panel/img/pro.jpg')); ?>" alt class="h-auto rounded-circle">
    </div>
   </a>
   <ul class="dropdown-menu dropdown-menu-end">
    <li>
     <a class="dropdown-item" href="<?php echo e(route('admin.content.users-management.users.profile.index')); ?>">
      <div class="d-flex">
       <div class="flex-shrink-0 me-3">
        <div class="avatar avatar-online">
         <img src="<?php echo e(asset('dr-assets/panel/img/pro.jpg')); ?>" alt class="h-auto rounded-circle">
       ...
       <div class="flex-grow-1">
        <span class="fw-medium d-block">
         <?php if(Auth::guard('manager')->check()): ?>
          <?php echo e(Auth::guard('manager')->user()->first_name . ' ' . Auth::guard('manager')->user()->last_name); ?>
        ...
        <small class="text-muted">
         <?php if(Auth::guard('manager')->user()->permission == 1): ?>
          <?php echo e('مدیر'); ?>

         <?php endif; ?>
         <?php if(Auth::guard('manager')->user()->permission == 2): ?>
          <?php echo e('ادمین'); ?>

         <?php endif; ?>
         <?php if(Auth::guard('manager')->user()->permission == 3): ?>
          <?php echo e('منشی سایت'); ?>
    ...
    <?php if(Auth::guard('manager')->check() && Laravel\Jetstream\Jetstream::hasApiFeatures()): ?>
     <li>
    ...
    <?php endif; ?>
    <li>
     <a class="dropdown-item" href="<?php echo e(route('admin.Dashboard.setting.index')); ?>">
    ...
    <?php if(Auth::guard('manager')->User() && Laravel\Jetstream\Jetstream::hasTeamFeatures()): ?>
     ...
     <li>
      <a class="dropdown-item"
       href="<?php echo e(Auth::guard('manager')->user() ? route('teams.show', Auth::guard('manager')->user()->currentTeam->id) : 'javascript:void(0)'); ?>">
     ...
     <?php endif; ?>
     <?php if(Auth::guard('manager')->user()->allTeams()->count() > 1): ?>
      <li>
       <div class="dropdown-divider"></div>
      </li>
      <li>
     ...
     <?php endif; ?>
     <?php if(Auth::guard('manager')->user()): ?>
      <?php $__currentLoopData = Auth::guard('manager')->user()->allTeams(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php if(Auth::guard('manager')->check()): ?>
     <li>
      <a class="dropdown-item logout" href="<?php echo e(route('admin.auth.logout')); ?>">
    ...
    <?php else: ?>
     <li>
      <a class="dropdown-item"
       href="<?php echo e(Route::has('auth-login-basic') ? route('auth-login-basic') : url('admin/auth/login-basic')); ?>">
...
<div class="navbar-search-wrapper search-input-wrapper <?php echo e(isset($menuHorizontal) ? $containerNav : ''); ?> d-none">
 <input type="text" class="form-control search-input <?php echo e(isset($menuHorizontal) ? '' : $containerNav); ?> border-0"
...
<!-- / Navbar -->
<?php /**PATH D:\MyProjects\Benobe\panel\resources\views/admin/content/layouts/sections/navbar/navbar.blade.php ENDPATH**/ ?>