<?php $__env->startSection('title', 'افزودن استان جدید '); ?>
...
<div class="app-content-body">
  ...
  <div class="bg-white-only lter b-b wrapper-md clrfix d-flex justify-content-between">
    ...
    <a href="<?php echo e(route('admin.Dashboard.cities.index')); ?>" class="btn btn-warning">بازگشت</a>
  ...
  <div class="wrapper-md w-100">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <form method="POST"
              action="<?php echo e(route('admin.Dashboard.cities.store')); ?>"
              action="?mod=zone"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.content.layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/admin/content/dashboard/cities/create.blade.php ENDPATH**/ ?>