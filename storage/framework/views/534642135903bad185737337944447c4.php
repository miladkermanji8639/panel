     ...
     <table class="table table-bordered table-striped">
      <tbody>
       <tr>
        ...
        <td>
         <!--[if BLOCK]><![endif]--><?php if($lastUpdated): ?>
          <?php
   ...
   <div class="panel panel-default shadow-sm">
    ...
    <div class="panel-body">
     ...
     <div class="d-flex gap-2 mt-3">
      ...
      <a href="<?php echo e(Storage::url('sitemap.xml')); ?>" target="_blank" class="btn btn-gradient-secondary flex-grow-1">
    ...
    <div class="row g-4">
     <div class="col-md-4">
      <div class="form-group">
       ...
       <!--[if BLOCK]><![endif]--><?php if($errors->has('newUrl')): ?>
        <span class="text-danger d-block mt-1"><?php echo e($errors->first('newUrl')); ?></span>
       <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
      </div>
     </div>
     <div class="col-md-2">
      <div class="form-group">
       ...
       <!--[if BLOCK]><![endif]--><?php if($errors->has('newPriority')): ?>
        <span class="text-danger d-block mt-1"><?php echo e($errors->first('newPriority')); ?></span>
       <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
      </div>
     </div>
     <div class="col-md-3">
      <div class="form-group">
       ...
       <!--[if BLOCK]><![endif]--><?php if($errors->has('newChangefreq')): ?>
        <span class="text-danger d-block mt-1"><?php echo e($errors->first('newChangefreq')); ?></span>
       <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
      </div>
     </div>
     <div class="col-md-2">
      <div class="form-group">
       ...
       <!--[if BLOCK]><![endif]--><?php if($errors->has('newLastmod')): ?>
        <span class="text-danger d-block mt-1"><?php echo e($errors->first('newLastmod')); ?></span>
       <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
      </div>
     </div>
    ...
    <div class="col-md-6">
     <div class="d-flex gap-2 justify-content-end">
      ...
      <button wire:click="deleteSelected" class="btn btn-gradient-danger rounded-pill px-4"
       <?php if(empty($selectedLinks)): ?> disabled <?php endif; ?>>
   ...
   <div class="card-body">
    <div class="table-responsive text-nowrap">
     <table class="table table-bordered">
      ...
      <tbody>
       <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <tr>
         <td><input type="checkbox" wire:model.live="selectedLinks" value="<?php echo e($link->id); ?>"
           class="form-check-input"></td>
         <td><?php echo e($links->firstItem() + $index); ?></td>
         <td>
          <!--[if BLOCK]><![endif]--><?php if($editId === $link->id): ?>
           <input type="url" class="form-control input-shiny" wire:model.live="editUrl">
           <!--[if BLOCK]><![endif]--><?php if($errors->has('editUrl')): ?>
            <span class="text-danger d-block mt-1"><?php echo e($errors->first('editUrl')); ?></span>
           <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
          <?php else: ?>
           <?php echo e($link->url); ?>
         ...
         <td>
          <!--[if BLOCK]><![endif]--><?php if($editId === $link->id): ?>
           ...
           <!--[if BLOCK]><![endif]--><?php if($errors->has('editPriority')): ?>
            <span class="text-danger d-block mt-1"><?php echo e($errors->first('editPriority')); ?></span>
           <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
          <?php else: ?>
           <?php echo e(number_format($link->priority, 1)); ?>
         ...
         <td>
          <!--[if BLOCK]><![endif]--><?php if($editId === $link->id): ?>
           ...
           <!--[if BLOCK]><![endif]--><?php if($errors->has('editChangefreq')): ?>
            <span class="text-danger d-block mt-1"><?php echo e($errors->first('editChangefreq')); ?></span>
           <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
          <?php else: ?>
           <?php echo e($link->changefreq); ?>

          <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
         </td>
         <td>
          <!--[if BLOCK]><![endif]--><?php if($editId === $link->id): ?>
           <input type="text" id="edit-date-input-<?php echo e($link->id); ?>"
            class="form-control input-shiny custom-datepicker" wire:model.live="editLastmod"
            placeholder="تاریخ را انتخاب کنید" readonly>
           <!--[if BLOCK]><![endif]--><?php if($errors->has('editLastmod')): ?>
            <span class="text-danger d-block mt-1"><?php echo e($errors->first('editLastmod')); ?></span>
           <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
          <?php else: ?>
           <?php
            if ($link->lastmod) {
         ...
         <td>
          <button wire:click="toggleStatus(<?php echo e($link->id); ?>)"
           class="badge <?php echo e($link->is_active ? 'bg-label-success' : 'bg-label-danger'); ?> border-0 cursor-pointer">
           <?php echo e($link->is_active ? 'فعال' : 'غیرفعال'); ?>
         ...
         <td>
          ...
          <?php else: ?>
           <div class="d-flex gap-2">
            <button wire:click="startEdit(<?php echo e($link->id); ?>)"
             class="btn btn-gradient-warning rounded-full w-8 h-8 flex items-center justify-center">
             <i class="fas fa-edit"></i>
            </button>
            <button onclick="confirmDelete(<?php echo e($link->id); ?>)"
    ...
    <div class="d-flex justify-content-between mt-4">
     <div class="text-muted">نمایش <?php echo e($links->firstItem()); ?> تا <?php echo e($links->lastItem()); ?> از
      <?php echo e($links->total()); ?> ردیف</div>
 ...
 <script>
  ...
  function confirmDelete(id) {
   Swal.fire({
    ...
    if (result.isConfirmed) {
     window.Livewire.find('<?php echo e($_instance->getId()); ?>').deleteLink(id);
    }
   });
  }
 </script>
</div>
<?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/admin/tools/sitemap.blade.php ENDPATH**/ ?>