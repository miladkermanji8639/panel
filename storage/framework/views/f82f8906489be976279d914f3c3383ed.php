    ...
    <div class="bg-white p-4 rounded-bottom shadow-sm">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <button class="btn btn-danger btn-sm" id="delete-selected-btn" <?php if(empty($selectedComments)): ?> disabled
                <?php endif; ?>>
                ...
                <tbody>
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td class="align-middle"><?php echo e($comments->firstItem() + $loop->index); ?></td>
                            <td class="align-middle"><?php echo e($comment->user_name); ?> <!--[if BLOCK]><![endif]--><?php if($comment->user_phone): ?> -
                            <?php echo e($comment->user_phone); ?> <?php endif; ?><!--[if ENDBLOCK]><![endif]--></td>
                            <td class="align-middle"><?php echo e(Str::limit($comment->comment, 50)); ?></td>
                            <td class="align-middle text-center">
                                <div class="form-check form-switch d-flex align-items-center justify-content-center">
                                    <input type="checkbox" class="form-check-input"
                                        wire:model.live="commentStatuses.<?php echo e($comment->id); ?>"
                                        wire:change="toggleStatus(<?php echo e($comment->id); ?>)" <?php if($comment->status): echo 'checked'; endif; ?>>
                                    <label
                                        class="form-check-label mx-1 text-muted"><?php echo e($comment->status ? 'فعال' : 'غیرفعال'); ?></label>
                                </div>
                            </td>
                            <td class="align-middle">
                            ...
                            <td class="align-middle">
                                <div class="d-flex gap-2">
                                    <a href="<?php echo e(route('admin.content.doctors.comment-doctor.show', $comment->id)); ?>"
                ...
                button.addEventListener('click', function (e) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.Livewire.find('<?php echo e($_instance->getId()); ?>').call('deleteComment', commentId);
                        }
                    });
                });
            });
...
</div><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/admin/doctors/comment-doctor/admin-doctors-comment-index.blade.php ENDPATH**/ ?>