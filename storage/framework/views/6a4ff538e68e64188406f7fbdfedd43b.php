<div class="container-fluid py-2">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 bg-light p-3 rounded-3 shadow-sm">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <button onclick="confirmDeleteSelected()" 
                        ...
                        <?php if(empty($selectedCategories)): ?> disabled <?php endif; ?>>
                    <i class="fas fa-trash fs-6"></i> حذف انتخاب‌شده‌ها
                </button>
                <a href="<?php echo e(route('admin.questions.question-cat.create')); ?>" 
    ...
    <div class="container px-0">
        <div class="row g-3">
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="col-12">
                        ...
                        <div class="card-body p-4 d-flex align-items-center justify-content-between gap-3 flex-wrap">
                            <div class="d-flex align-items-center gap-3">
                                <input type="checkbox" class="form-check-input flex-shrink-0 shadow-sm" 
                                    wire:model.live="selectedCategories" value="<?php echo e($category->id); ?>">
                                <div class="flex-grow-1">
                                    <h6 class="mb-1 fw-semibold text-dark"><?php echo e($category->name); ?></h6>
                                    <small class="text-muted d-block"><?php echo e($category->alt_name ?? 'بدون نام جایگزین'); ?></small>
                                </div>
                            </div>
                            <div class="d-flex align-items-center gap-3">
                                <div class="form-check form-switch">
                                    <input type="checkbox" class="form-check-input shadow-sm" 
                                        wire:model="categoryStatuses.<?php echo e($category->id); ?>" 
                                        wire:click="toggleStatus(<?php echo e($category->id); ?>)" 
                                        id="status-<?php echo e($category->id); ?>"
                                        <?php echo e($categoryStatuses[$category->id] ? 'checked' : ''); ?>>
                                    <label class="form-check-label text-muted fw-medium mx-2" for="status-<?php echo e($category->id); ?>">
                                        <?php echo e($categoryStatuses[$category->id] ? 'فعال' : 'غیرفعال'); ?>
...
</div><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/admin/questions/question-cat-list.blade.php ENDPATH**/ ?>