<div>
  <div class="card">
    <div class="card-header">
      <h5 class="card-title">ویرایش پزشک برتر</h5>
    </div>
    <div class="card-body">
      <form wire:submit.prevent="update">
        ...
        <option value="<?php echo e($doctor->id); ?>">
          <?php echo e($doctor->first_name . ' ' . $doctor->last_name . ' (' . $doctor->national_code . ')'); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
      ...
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
          ...
          <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['hospital_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
</div><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/admin/dashboard/home_page/edit-best-doctor.blade.php ENDPATH**/ ?>