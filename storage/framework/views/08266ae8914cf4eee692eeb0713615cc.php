...
<?php $__env->startSection('bread-crumb-title', ' ویرایش پروفایل '); ?>
<div class="main-content mb-5">
 <?php if(!$doctor->profile_completed && count($incompleteSections) > 0): ?>
  <div class="alert alert-warning text-center">
   <span class="font-weight-bold">
    پروفایل شما کامل نیست. لطفا بخش‌های زیر را تکمیل کنید:
    <ul class="w-100 d-flex gap-4">
     <?php $__currentLoopData = $doctor->getIncompleteProfileSections(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <li class="badge badge-danger p-2"><?php echo e($section); ?></li>
 ...
 <div class="d-flex justify-content-center align-items-center flex-column col-12">
  <div class="top-profile-info p-2 col-xs-12 col-sm-12  col-md-12 col-lg-8 d-flex">
   <div class="d-flex justify-content-between w-100 font-size-13">
    <div class="d-flex align-items-start">
     <div>
      <img src="<?php echo e(asset('dr-assets/panel/img/pro.jpg')); ?>" class="avatar___img-main">
     </div>
     <div class="mx-2 mt-3">
      <span class="d-block font-weight-bold font-size-15 profile-header-name">
       <?php echo e(Auth::guard('doctor')->user()->first_name . ' ' . Auth::guard('doctor')->user()->last_name); ?></span>
      <span class="badge badge-light p-2 border-radius-8 mt-3 mx-3 font-size-13 cursor-pointer">
       <?php echo e($specialtyName); ?>
  ...
  <div class="option-card-box-shodow p-3 col-xs-12 col-sm-12  col-md-12 col-lg-8" id="personal-data">
   ...
   <div class="drop-toggle-styles personal-data-drop-toggle">
    ...
    <div class="">
     <form action="<?php echo e(route('dr-update-profile')); ?>" method="POST" id="profileEdit">
      <?php echo csrf_field(); ?>
      <div class="mt-2">
       <label for="name" class="label-top-input">نام</label>
       <input type="text" class="my-form-control w-100 border-radius-6 mt-3"
        value="<?php echo e(Auth::guard('doctor')->user()->first_name); ?>" name="first_name" readonly>
       <?php $__errorArgs = ['first_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
        <span class="text-danger font-weight-bold mt-2"><?php echo e($message); ?></span>
       <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="mt-2">
       ...
       <input type="text" class="my-form-control w-100 border-radius-6 mt-3"
        value="<?php echo e(Auth::guard('doctor')->user()->last_name); ?>" name="last_name" readonly>
      </div>
      <div class="mt-2">
       <label for="name" class="label-top-input">کدملی</label>
       <input type="text" value="<?php echo e(Auth::guard('doctor')->user()->national_code ?? ''); ?>"
      ...
      <div class="mt-2">
       ...
       <input type="text" value="<?php echo e(Auth::guard('doctor')->user()->license_number ?? ''); ?>"
      ...
      <div class="d-flex justify-content-between mt-4 gap-4 position-relative">
       ...
       <input class="my-form-control h-50 col-lg-11 col-xs-10 col-md-11 col-sm-11 text-right disabled "
        placeholder="شماره موبایل" name="mobile" value="<?php echo e(Auth::guard('doctor')->user()->mobile ?? ''); ?>" disabled>
       <button
      ...
      <div class="mt-3">
       ...
       <textarea class="ckeditor form-control" name="description" class="form-control" id="description">
            <?php echo e(trim(Auth::guard('doctor')->user()->bio ?? '')); ?>
  ...
  <div class="option-card-box-shodow p-3 col-xs-12 col-sm-12  col-md-12 col-lg-8" id="specialty-section">
   ...
   <div class="drop-toggle-styles takasos-data-drop-toggle">
    ...
    <div>
     ...
     <div class="mt-2">
      <form action="<?php echo e(route('dr-specialty-update')); ?>" method="POST" id="specialtyEdit">
       <?php echo csrf_field(); ?>
       <div class="d-flex justify-content-between gap-4 flex-xs-wrap flex-xs-column">
        <div class="mt-2 w-100">
         ...
         <select name="academic_degree_id" id="academic_degree_id"
          ...
          <?php $__currentLoopData = $academic_degrees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $academic_degree): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           <option value="<?php echo e($academic_degree->id); ?>"
            <?php echo e((Auth::guard('doctor')->user()->academic_degree_id ?? '') == ($academic_degree->id ?? '') ? 'selected' : ''); ?>>
            <?php echo e($academic_degree->title ?? ''); ?>
        ...
        <div class="mt-2 w-100">
         ...
         <select name="specialty_id" id="specialties_list"
          ...
          <?php $__currentLoopData = $sub_specialties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specialtyOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           <option value="<?php echo e($specialtyOption->id); ?>"
            <?php echo e($specialtyOption->id == ($currentSpecialty->specialty_id ?? '') ? 'selected' : ''); ?>>
            <?php echo e($specialtyOption->name); ?>
       ...
       <div class="position-relative">
        ...
        <input type="text" value="<?php echo e($specialtyName); ?>" name="specialty_title"
       ...
       <div id="additionalInputs">
        ...
        <?php $__currentLoopData = $specialties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $specialty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         <?php if($index > 0): ?>
          <div class="w-100 mt-3 specialty-item" data-specialty-id="<?php echo e($specialty->id); ?>">
           ...
           <div>
            <div class="mt-2">
             <div class="d-flex justify-content-between gap-4">
              <div class="w-100">
               <label for="degree<?php echo e($index + 1); ?>" class="label-top-input">درجه علمی</label>
               <select name="degrees[<?php echo e($index); ?>]" id="degree<?php echo e($index + 1); ?>"
                class="form-control h-50 w-100 border-radius-6 mt-3 col-12 position-relative daraje" disabled>
                <?php $__currentLoopData = $academic_degrees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $academic_degree): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 <option value="<?php echo e($academic_degree->id); ?>"
                  <?php echo e($specialty->academic_degree_id == $academic_degree->id ? 'selected' : ''); ?>>
                  <?php echo e($academic_degree->title); ?>
              ...
              <div class="w-100">
               <label for="specialty<?php echo e($index + 1); ?>" class="label-top-input">تخصص</label>
               <select name="specialties[<?php echo e($index); ?>]" id="specialty<?php echo e($index + 1); ?>"
                class="form-control h-50 w-100 border-radius-6 mt-3 col-12 position-relative takhasos-input" disabled>
                <?php $__currentLoopData = $sub_specialties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specialtyOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 <option value="<?php echo e($specialtyOption->id); ?>"
                  <?php echo e($specialty->specialty_id == $specialtyOption->id ? 'selected' : ''); ?>>
                  <?php echo e($specialtyOption->name); ?>
             ...
             <div>
              <label for="title<?php echo e($index + 1); ?>" class="label-top-input-special-takhasos-elem-create">عنوان
               تخصص</label>
              <input type="text" name="titles[<?php echo e($index); ?>]" id="title<?php echo e($index + 1); ?>"
               class="form-control h-50 w-100 border-radius-6 mt-3" value="<?php echo e($specialty->specialty_title); ?>"
               disabled>
             </div>
            </div>
           </div>
       ...
       <div class="d-flex justify-content-between mt-2 gap-4">
        ...
        <button
         ...
         <?php echo e($existingSpecialtiesCount >= 3 || $existingSpecialtiesCount < 1 ? 'disabled' : ''); ?>>
    ...
    <div>
     <div class="mx-auto mt-2">
      <div class="bg-white py-3 rounded">
       ...
       <form action="<?php echo e(route('dr-uuid-update')); ?>" method="POST" id="uuid-form">
        <?php echo csrf_field(); ?>
        <div class="row">
         <div class="col-12 position-relative">
          <h4 class="text-left"><span class="color-999">benobe.ir/ </span><span class="color-nobat">
            <?php echo e(Auth::guard('doctor')->user()->uuid ?? '1997'); ?>

           </span></h4>
          <div class="mt-3 w-100">
           <label class="label-top-input-special-takhasos"> آی دی خود را وارد نمایید : </label>
           <input class="form-control mt-2 h-50" type="text" value="<?php echo e(Auth::guard('doctor')->user()->uuid); ?>"
            name="uuid">
          </div>
         </div>
        </div>
       ...
       <div class="w-100">
        <div class="w-100">
         <input type="text" name="ita_phone" class="form-control h-50 border-radius-4" placeholder="شماره موبایل"
          maxlength="11" value="<?php echo e($messengers->where('messenger_type', 'ita')->first()->phone_number ?? ''); ?>">
        </div>
        <div class="mt-2 w-100">
         <input type="text" name="ita_username" class="form-control h-50 border-radius-4 mt-2"
          placeholder="نام کاربری ایتا"
          value="<?php echo e($messengers->where('messenger_type', 'ita')->first()->username ?? ''); ?>">
        </div>
       </div>
      </div>
      <div class="mt-2">
       ...
       <div class="w-100">
        <div class="w-100">
         <input type="text" name="whatsapp_phone" class="form-control h-50 border-radius-4 col-12"
          ...
          value="<?php echo e($messengers->where('messenger_type', 'whatsapp')->first()->phone_number ?? ''); ?>">
        </div>
       </div>
      </div>
      <div class="mt-2">
        ...
        <div class="flex items-center rounded-lg elative MuiBox-root muirtl-0">
         <div class="password_toggle__AXK9v">
          <input type="checkbox" id="secure_call" name="secure_call" value="1"
           <?php echo e(($messengers->where('messenger_type', 'ita')->first()->is_secure_call ?? false) ||
   ...
   <div class="drop-toggle-styles password-data-drop-toggle">
    ...
    <div>
     <div class="accordion_content__bS0xm">
      <form class="w-100" action="<?php echo e(route('dr-static-password-update')); ?>" method="POST"
       ...
       <div class="d-flex align-items-center mt-2">
        <div class="password_toggle__AXK9v d-flex align-items-center">
         <input type="checkbox" id="static_password_enabled" name="static_password_enabled" value="1"
          <?php echo e(Auth::guard('doctor')->user()->static_password_enabled ? 'checked' : ''); ?>>
       ...
       <div class="w-100 d-flex justify-content-between gap-4 flex-xs-wrap flex-xs-column">
        <div class="w-100">
         ...
         <input type="password" class="form-control h-50 w-100 border-radius-6 mt-3 col-12 position-relative daraje"
          ...
          <?php echo e(Auth::guard('doctor')->user()->static_password_enabled ? '' : 'disabled'); ?>>
       ...
       <div class="w-100 mt-3">
        <button type="submit" class="btn btn-primary h-50 col-12 d-flex justify-content-center align-items-center"
         id="btn-save-pass" <?php echo e(Auth::guard('doctor')->user()->static_password_enabled ? '' : 'disabled'); ?>>
         <span class="button_text">ذخیره تغیرات</span>
         <div class="loader"></div>
        </button>
       </div>
      ...
      <div class="d-flex align-items-center mt-3">
       <div class="password_toggle__AXK9v d-flex align-items-center">
        <input type="checkbox" id="two_factor_enabled" name="two_factor_enabled" value="1"
         <?php echo e(Auth::guard('doctor')->user()->two_factor_secret_enabled ? 'checked' : ''); ?>>
        <label for="two_factor_enabled">Toggle</label>
       </div>
       <span class="mx-1"> گذرواژه دو مرحله ای فعال است</span>
      </div>
      <form class="w-100" action="<?php echo e(route('dr-two-factor-update')); ?>" method="POST" id="twoFactorForm">
       <?php echo csrf_field(); ?>
       <div class="w-100 d-flex justify-content-between gap-4 flex-xs-wrap flex-xs-column">
        <div class="w-100">
         ...
         <input type="text" class="form-control h-50 w-100 border-radius-6 mt-3 col-12 position-relative daraje"
          ...
          <?php echo e(Auth::guard('doctor')->user()->two_factor_secret_enabled ? '' : 'disabled'); ?>>
        </div>
       </div>
       <div class="w-100 mt-3">
        <button type="submit" class="btn btn-primary h-50 col-12 d-flex justify-content-center align-items-center"
         id="btn-save-two-factor" <?php echo e(Auth::guard('doctor')->user()->two_factor_secret_enabled ? '' : 'disabled'); ?>>
         <span class="button_text">ذخیره تغیرات</span>
         <div class="loader"></div>
        </button>
       </div>
...
<script src="<?php echo e(asset('dr-assets/panel/js/profile/edit-profile.js')); ?>"></script>
<script>
 var appointmentsSearchUrl = "<?php echo e(route('search.appointments')); ?>";
</script>
<?php echo $__env->make('dr.panel.profile.option.profile-option', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('dr.panel.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/dr/panel/profile/edit-profile.blade.php ENDPATH**/ ?>