<div class="container-fluid py-5">
    ...
    <header class="glass-header p-4 rounded-3 mb-5 shadow-lg">
        <div class="d-flex align-items-center gap-3">
            ...
            <h4 class="mb-0 fw-bold text-white">افزودن ویدئو صفحه نخست</h4>
        </div>
    </header>
    ...
    <div class="container px-0">
        <div class="card border-0 rounded-3 shadow-md bg-gradient-card">
            <div class="card-header bg-gradient-primary text-white p-4 rounded-top-3">
                <h5 class="mb-0 fw-bold">افزودن ویدئو جدید</h5>
            </div>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="file" class="form-control shadow-sm border-0 bg-white" wire:model="image" accept="image/*">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="file" class="form-control shadow-sm border-0 bg-white" wire:model="video" accept="video/mp4">
                            <div wire:loading wire:target="video" class="progress mt-2" style="height: 8px;">
                                <div class="progress-bar bg-gradient-primary animate-pulse" role="progressbar" style="width: 100%;"></div>
                            </div>
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['video'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger d-block mt-1"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check form-switch">
                                <input type="checkbox" class="form-check-input shadow-sm" wire:model="approve" id="approveSwitch">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control shadow-sm border-0 bg-white" wire:model="description" rows="5"></textarea>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="col-12 d-flex justify-content-between align-items-center gap-3 mt-4">
                            <a href="<?php echo e(route('admin.content-management.home-video.index')); ?>" 
                               class="btn btn-gradient-warning rounded-pill px-4 py-2 d-flex align-items-center gap-2">
                                <i class="fas fa-arrow-right"></i> بازگشت
                            </a>
                            <button type="submit" class="btn btn-gradient-success rounded-pill px-4 py-2 d-flex align-items-center gap-2">
...
</div><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/admin/content-management/home-video-create.blade.php ENDPATH**/ ?>