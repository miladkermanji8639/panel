      ...
      <div class="content-wrapper">
        ...
        <div class="flex-grow-1  container-fluid">
          ...
          <section class="toast-wrapper d-flex flex-column justify-content-center align-items-center">
            <?php echo $__env->make('admin.content.alerts.toast.error', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('admin.content.alerts.toast.success', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          </section>
                    ...
                    <div
                      ...
                      <div class="dt-buttons btn-group flex-wrap">
                        ...
                        <button class="btn btn-secondary add-new btn-primary ms-2 ms-sm-0 waves-effect waves-light"
                                tabindex="0"
                                onclick="location.href='<?php echo e(route('admin.doctors.doctors-management.create')); ?>'"
                                aria-controls="DataTables_Table_0"
                    ...
                    <tbody>
                      ...
                      <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                          ...
                          <td>
                            <?php echo e($doctor->city ? $doctor->city->name : 'انتخاب نشده'); ?>

                            /
                            <?php echo e($doctor->province ? $doctor->province->name : 'انتخاب نشده'); ?>

                          </td>
                          <td>
                            <span id="<?php echo e($doctor->id); ?>"
                                  title="برای فعال یا غیر فعالسازی وضعیت کلیک کنید"
                                  onclick="changeStatus(<?php echo e($doctor->id); ?>)"
                                  data-url="<?php echo e(route('admin.doctor.status', $doctor->id)); ?>"
                                  class="badge bg-label-<?php echo e($doctor->status == 1 ? 'success' : 'danger'); ?> me-1 cursor-pointer"
                                  <?php echo e($doctor->status === 1 ? 'active' : 'deactive'); ?>>
                              <?php echo e($doctor->status === 0 ? 'غیر فعال' : 'فعال'); ?>
                            ...
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item"
                                   onclick="location.href='<?php echo e(route('admin.doctors.doctors-management.edit')); ?>'"
                                   href="javascript:void(0);">
                                  <i class="ti ti-pencil me-1"></i>
                                  ویرایش
                                </a>
                                <a class="dropdown-item"
                                   onclick="location.href='<?php echo e(route('admin.doctors.doctors-management.bime.index')); ?>'"
                                   href="javascript:void(0);">
                                  <i class="ti ti-pencil me-1"></i>
                                  بیمه ها
                                </a>
                                <a class="dropdown-item"
                                   onclick="location.href='<?php echo e(route('admin.content.doctors.doctors-management.nobatdehi-setting.index')); ?>'"
                                   href="javascript:void(0);">
                                  <i class="ti ti-pencil me-1"></i>
                                  ویرایش برنامه نوبت دهی
                                </a>
                                <a class="dropdown-item"
                                   onclick="location.href='<?php echo e(route('admin.content.doctors.doctors-management.moshavere-setting.index')); ?>'"
                                   href="javascript:void(0);">
                                  <i class="ti ti-pencil me-1"></i>
                                  ویرایش برنامه مشاوره تلفنی
                                </a>
                                <a class="dropdown-item"
                                   onclick="location.href='<?php echo e(route('admin.content.doctors.doctors-management.gallery.index')); ?>'"
                                   href="javascript:void(0);">
                                  <i class="ti ti-pencil me-1"></i>
                                  گالری عکس
                                </a>
                                <a class="dropdown-item"
                                   onclick="location.href='<?php echo e(route('admin.doctors.order-visit.show')); ?>'"
                                   href="javascript:void(0);">
