<div class="container-fluid py-1">
    <header class="glass-header p-3 rounded-3 mb-2 shadow-lg">
        <div class="d-flex align-items-center justify-content-between gap-3">
            ...
            <a href="<?php echo e(route('admin.content.hospitals.hospitals-management.create')); ?>" class="btn btn-outline-light rounded-pill px-3">
        ...
        <div class="row g-3 align-items-center">
            ...
            <div class="col-md-6 col-sm-12 d-flex justify-content-end gap-2">
                <button wire:click="deleteSelected" class="btn btn-outline-danger rounded-pill px-3" 
                        <?php if(empty($selectedHospitals)): ?> disabled <?php endif; ?>>
        ...
        <div class="card-body p-3">
            <div class="table-responsive text-nowrap">
                <table class="table table-bordered table-striped table-sm">
                    ...
                    <tbody>
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $hospitals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $hospital): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td><input type="checkbox" wire:model.live="selectedHospitals" value="<?php echo e($hospital->id); ?>" class="form-check-input"></td>
                                <td><?php echo e($hospitals->firstItem() + $index); ?></td>
                                <td><?php echo e($hospital->doctor->first_name . ' ' . $hospital->doctor->last_name); ?></td>
                                <td><?php echo e($hospital->name); ?></td>
                                <td><?php echo e($hospital->phone_number ?? '---'); ?></td>
                                <td><?php echo e(\App\Helpers\JalaliHelper::toJalaliDateTime($hospital->created_at)); ?></td>
                                <td>
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" 
                                               wire:click="toggleStatus(<?php echo e($hospital->id); ?>)" 
                                               <?php echo e($hospital->is_active ? 'checked' : ''); ?>>
                                    </div>
                                </td>
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li><a class="dropdown-item" href="https://benobe.ir/authlogin/<?php echo e($hospital->id); ?>" target="_blank">
                                                <i class="fa fa-sign-in"></i> ورود
                                            </a></li>
                                            <li><a class="dropdown-item" href="<?php echo e(route('admin.content.hospitals.hospitals-management.edit', $hospital->id)); ?>">
                                                <i class="fa fa-edit"></i> ویرایش
                                            </a></li>
                                            <li><a class="dropdown-item" href="#">مدیریت پزشکان</a></li>
                                            <li><a class="dropdown-item text-danger" href="#" wire:click.prevent="deleteHospital(<?php echo e($hospital->id); ?>)">
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="text-muted fs-6">نمایش <?php echo e($hospitals->firstItem()); ?> تا <?php echo e($hospitals->lastItem()); ?> از <?php echo e($hospitals->total()); ?> ردیف</div>
...
</div><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/admin/hospitals/hospitals-management/hospital-list.blade.php ENDPATH**/ ?>