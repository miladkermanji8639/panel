...
<link rel="stylesheet" href="<?php echo e(asset('dr-assets/panel/css/doctors-clininc/activation/index.css')); ?>">
 ...
 <link rel="stylesheet" href="<?php echo e(asset('dr-assets/panel/css/doctors-clinic/duration/duration.css')); ?>">
 <link rel="stylesheet" href="<?php echo e(asset('dr-assets/panel/css/doctors-clinic/activation/workhours/workhours.css')); ?>">
...
<header class="bg-light text-dark p-3 my-shodow w-100 d-flex align-items-center">
  <div class="back w-50">
    <a href="<?php echo e(route('duration.index', $clinicId)); ?>" class="btn btn-light">
    ...
    <div class="">
     <div class="card p-4">
      ...
      <form id="workingHoursForm">
       <?php echo csrf_field(); ?>
       <input type="hidden" name="clinic_id" value="<?php echo e($clinicId); ?>">
 ...
 <script>
  document.getElementById('startAppointmentBtn').addEventListener('click', function () {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          $.ajax({
            url: `<?php echo e(route('start.appointment')); ?>`,
            method: 'POST',
            data: {
              doctor_id: "<?php echo e($doctorId); ?>",
              clinic_id: "<?php echo e($clinicId); ?>",
  ...
  function loadWorkHours() {
      $.ajax({
        url: `<?php echo e(route('workhours.get', ['clinicId' => $clinicId, 'doctorId' => $doctorId])); ?>`,
        method: "GET",
        success: function (response) {
          ...
          <button class="btn btn-light btn-sm" onclick="deleteWorkHours('${timeRange}', '${days.join(',')}')">
            <img src="<?php echo e(asset('dr-assets/icons/trash.svg')); ?>">
            </button>
        `;
            list.appendChild(li);
          }
  ...
  function deleteWorkHours(timeRange, days) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          $.ajax({
            url: `<?php echo e(route('activation.workhours.delete')); ?>`,
            method: "POST",
            data: {
              doctor_id: "<?php echo e($doctorId); ?>",
              clinic_id: "<?php echo e($clinicId); ?>",
  ...
  function formatTime(time) {
    ...
    document.getElementById('workingHoursForm').addEventListener('submit', function (e) {
      ...
      $.ajax({
        url: "<?php echo e(route('activation.workhours.store')); ?>",
        method: "POST",
        data: formData,
        beforeSend: function () {
          $('#saveButton').html(
...
<?php /**PATH D:\MyProjects\Benobe\panel\resources\views/dr/panel/doctors-clinic/activation/workhours/index.blade.php ENDPATH**/ ?>