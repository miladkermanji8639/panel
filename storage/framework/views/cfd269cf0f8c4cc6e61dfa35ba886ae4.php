<div class="container-fluid py-4">
    ...
    <div class="bg-light text-dark p-4 rounded-top border">
        <div class="d-flex align-items-center justify-content-between">
            ...
            <a href="<?php echo e(route('admin.content-management.category-blog.create')); ?>" class="btn btn-primary">
    ...
    <div class="bg-white p-4 rounded-bottom shadow-sm">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <button class="btn btn-danger" id="delete-selected-btn" <?php if(empty($selectedCategories)): ?> disabled <?php endif; ?>>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item"
                                            href="<?php echo e(route('admin.content-management.category-blog.edit', $category->id)); ?>">
...
</div><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/admin/content-management/category-blog-list.blade.php ENDPATH**/ ?>