...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="col-md-4">
                    <div class="d-flex gap-2">
                        ...
                        <button wire:click="deleteSelected" class="btn btn-gradient-danger rounded-pill px-4" <?php if(empty($selectedMembers)): ?> disabled <?php endif; ?>>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><input type="checkbox" wire:model.live="selectedMembers" value="<?php echo e($member->id); ?>" class="form-check-input"></td>
                                    <td><?php echo e($members->firstItem() + $index); ?></td>
                                    <td>
                                        <!--[if BLOCK]><![endif]--><?php if($editId === $member->id): ?>
                                    ...
                                    <td>
                                        <button wire:click="toggleStatus(<?php echo e($member->id); ?>)" class="badge <?php echo e($member->is_active ? 'bg-label-success' : 'bg-label-danger'); ?> border-0 cursor-pointer">
                                            <?php echo e($member->is_active ? 'فعال' : 'غیرفعال'); ?>
                                    ...
                                    <td>
                                        ...
                                        <?php else: ?>
                                            <div class="d-flex gap-2">
                                                <button wire:click="startEdit(<?php echo e($member->id); ?>)" class="btn btn-gradient-warning rounded-full w-8 h-8 flex items-center justify-center">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                                <button onclick="confirmDelete(<?php echo e($member->id); ?>)" class="btn btn-gradient-danger rounded-full w-8 h-8 flex items-center justify-center">
                ...
                <div class="d-flex justify-content-between mt-4">
                    <div class="text-muted">نمایش <?php echo e($members->firstItem()); ?> تا <?php echo e($members->lastItem()); ?> از <?php echo e($members->total()); ?> ردیف</div>
    ...
    <script>
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').deleteMember(id);
                }
            });
        }
    </script>
</div><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/admin/tools/news-latter.blade.php ENDPATH**/ ?>