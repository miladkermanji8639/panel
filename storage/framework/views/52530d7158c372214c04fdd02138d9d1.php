			 ...
			 <div class="user-profile-info">
			  ...
			  <ul
			   ...
			   <li class="list-inline-item d-flex gap-1"> <i class="ti ti-calendar"></i>
				...
				عضویت در
				<?php echo e(Auth::guard('manager')->user()->created_at); ?>
	   ...
	   <div class="row">
		<div class="col-md-12">
		 <ul class="nav nav-pills flex-column flex-sm-row mb-4">
		  ...
		  <li class="nav-item"><a class="nav-link" href="<?php echo e(url('pages/profile-teams')); ?>"><i
			 class='ti-xs ti ti-users me-1'></i>
			تیم ها</a></li>
		  <li class="nav-item"><a class="nav-link" href="<?php echo e(url('pages/profile-projects')); ?>"><i
			 class='ti-xs ti ti-layout-grid me-1'></i> پروژه ها</a></li>
		  <li class="nav-item"><a class="nav-link" href="<?php echo e(url('pages/profile-connections')); ?>"><i
		   ...
		   <ul class="timeline mb-0 ms-1">
			<li class="timeline-item timeline-item-transparent"> <span
			 ...
			 <div class="timeline-event">
			  ...
			  <div class="d-flex flex-wrap">
			   <div class="avatar me-2"> <img src="<?php echo e(asset('assets/img/avatars/3.png')); ?>" alt="آواتار"
			...
			<li class="timeline-item timeline-item-transparent"> <span class="timeline-point timeline-point-danger"></span>
			 <div class="timeline-event">
			  ...
			  <p class="mb-2"> ارسال توسط زهرا نعمتیان <img src="<?php echo e(asset('assets/img/avatars/4.png')); ?>"
				class="rounded-circle me-3" alt="" height="24" width="24" /> </p>
			  <div class="d-flex flex-wrap gap-2 pt-1">
			   <a href="javascript:void(0)" class="me-3"><img src="<?php echo e(asset('assets/img/icons/misc/doc.png')); ?>"
				 alt="دستورالعمل های برنامه تصویر" width="15" class="me-2" /> <span
				 class="fw-medium text-heading">فایل CSS</span></a>
			   <a href="javascript:void(0)"><img src="<?php echo e(asset('assets/img/icons/misc/xls.png')); ?>"
			 ...
			 <ul class="list-unstyled mb-0">
			  <li class="mb-3">
			   <div class="d-flex align-items-start">
				<div class="d-flex align-items-start">
				 <div class="avatar me-2"> <img src="<?php echo e(asset('assets/img/avatars/2.png')); ?>" alt="آواتار"
				   class="rounded-circle" /> </div>
				 <div class="me-2 ms-1">
			  ...
			  <li class="mb-3">
			   <div class="d-flex align-items-start">
				<div class="d-flex align-items-start">
				 <div class="avatar me-2"> <img src="<?php echo e(asset('assets/img/avatars/10.png')); ?>" alt="آواتار"
				   class="rounded-circle" /> </div>
				 <div class="me-2 ms-1">
			  ...
			  <li class="mb-3">
			   <div class="d-flex align-items-start">
				<div class="d-flex align-items-start">
				 <div class="avatar me-2"> <img src="<?php echo e(asset('assets/img/avatars/7.png')); ?>" alt="آواتار"
				   class="rounded-circle" /> </div>
				 <div class="me-2 ms-1">
			  ...
			  <li class="mb-3">
			   <div class="d-flex align-items-start">
				<div class="d-flex align-items-start">
				 <div class="avatar me-2"> <img src="<?php echo e(asset('assets/img/avatars/12.png')); ?>" alt="آواتار"
				   class="rounded-circle" /> </div>
				 <div class="me-2 ms-1">
			 ...
			 <ul class="list-unstyled mb-0">
			  <li class="mb-3">
			   <div class="d-flex align-items-center">
				<div class="d-flex align-items-start">
				 <div class="avatar me-2"> <img src="<?php echo e(asset('assets/img/icons/brands/react-label.png')); ?>"
			  ...
			  <li class="mb-3">
			   <div class="d-flex align-items-center">
				<div class="d-flex align-items-start">
				 <div class="avatar me-2"> <img src="<?php echo e(asset('assets/img/icons/brands/support-label.png')); ?>"
				   alt="آواتار" class="rounded-circle" /> </div>
				 <div class="me-2 ms-1">
			  ...
			  <li class="mb-3">
			   <div class="d-flex align-items-center">
				<div class="d-flex align-items-start">
				 <div class="avatar me-2"> <img src="<?php echo e(asset('assets/img/icons/brands/figma-label.png')); ?>"
				   alt="آواتار" class="rounded-circle" /> </div>
				 <div class="me-2 ms-1">
			  ...
			  <li class="mb-3">
			   <div class="d-flex align-items-center">
				<div class="d-flex align-items-start">
				 <div class="avatar me-2"> <img src="<?php echo e(asset('assets/img/icons/brands/vue-label.png')); ?>" alt="آواتار"
				   class="rounded-circle" /> </div>
				 <div class="me-2 ms-1">
			  ...
			  <li class="mb-3">
			   <div class="d-flex align-items-center">
				<div class="d-flex align-items-start">
				 <div class="avatar me-2"> <img src="<?php echo e(asset('assets/img/icons/brands/twitter-label.png')); ?>"
				   alt="آواتار" class="rounded-circle" /> </div>
				 <div class="me-2 ms-1">
...
<?php echo $__env->make('admin.content.layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/admin/content/users-management/users/profile/pages-profile-user.blade.php ENDPATH**/ ?>