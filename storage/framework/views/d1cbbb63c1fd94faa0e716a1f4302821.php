         ...
         <td class="text-center">
          <div class="dropdown">
           ...
           <ul class="dropdown-menu">
            ...
            <li><a href="<?php echo e(route('admin.doctors.doctors-management.bime.index', $doctor->id)); ?>"
              class="dropdown-item"><i class="fa fa-edit"></i> بیمه‌ها</a></li>
            <li><a
              href="<?php echo e(route('dr-workhours', $doctor->id)); ?>"
              class="dropdown-item"><i class="fa fa-calendar-times-o"></i> برنامه نوبت‌دهی</a></li>
            <li><a
              href="<?php echo e(route('dr-moshavere_setting', $doctor->id)); ?>"
