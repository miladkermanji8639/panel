<?php $__env->startSection('styles'); ?>
 ...
 <link type="text/css" href="<?php echo e(asset('dr-assets/panel/css/profile/subuser.css')); ?>" rel="stylesheet" />
...
<?php $__env->startSection('bread-crumb-title', ' مدیریت منشی '); ?>
     ...
     <form id="edit-secretary-form" method="post">
      ...
      <div class="d-flex flex-column mt-2">
       ...
       <div class="d-flex
        ...
        <div class="form-group position-relative w-100 hide-show-input-edit">
         <label class="label-top-input-special-takhasos"> کدملی: </label>
         <input type="text" name="national_code" id="edit-national-code" class="form-control h-50 w-100">
         <small class="text-danger error-national_code mt-1"></small>
        </div>
        <div class="form-group position-relative w-100 hide-show-input-edit">
         <label class="label-top-input-special-takhasos">جنسیت : </label>
...
<div class="subuser-content w-100 d-flex justify-content-center mt-4">
 ...
 <div class="subuser-content-wrapper p-3">
  ...
  <div class="subuser-cards mt-4">
   <?php if(count($secretaries) > 0): ?>
    <?php $__currentLoopData = $secretaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $secretary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
     <div class="subuser-card p-3 w-100 d-flex justify-content-between align-items-end">
      <div>
       <span class="d-block font-weight-bold text-dark"> <?php echo e($secretary->first_name); ?>

        <?php echo e($secretary->last_name); ?></span>
       <span class="font-size-13 font-weight-bold">
        شماره موبایل: <span><?php echo e($secretary->mobile); ?></span>
       </span>
       <span class="font-size-13 mx-2 font-weight-bold">
        کدملی:<?php echo e($secretary->national_code); ?>
      ...
      <div>
       <div class="d-flex  gap-4">
        <button data-toggle="modal" data-target="#exampleModalCenterEditSubuser"
         class="btn btn-light btn-sm rounded-circle edit-btn" data-id="<?php echo e($secretary->id); ?>">
        ...
        <button class="btn btn-light btn-sm rounded-circle delete-btn" data-id="<?php echo e($secretary->id); ?>">
   ...
   <?php else: ?>
    <div class="alert alert-info w-100 d-flex justify-content-center align-items-center">شما منشی فعالی ندارید</div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    $('#add-secretary-form').on('submit', function(e) {
     ...
     $.ajax({
    url: "<?php echo e(route('dr-secretary-store')); ?>",
    method: 'POST',
    ...
    $(document).on('click', '.edit-btn', function() {
     ...
     $.get(
    "<?php echo e(route('dr-secretary-edit', ':id')); ?>".replace(':id', id) +
    ...
    toastr.error('خطا در دریافت اطلاعات منشی!');
     ...
     $.ajax({
       url: "<?php echo e(route('dr-secretary-update', ':id')); ?>".replace(':id', id),
       method: 'POST',
       data: formData,
       success: function (response) {
     ...
     $(document).on('click', '.delete-btn', function () {
       ...
       if (result.isConfirmed) {
         $.ajax({
         url: "<?php echo e(route('dr-secretary-delete', ':id')); ?>".replace(':id', id) + '?selectedClinicId=' + selectedClinicId,
         method: 'DELETE',
         headers: {
...
<?php echo $__env->make('dr.panel.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/dr/panel/secretary/index.blade.php ENDPATH**/ ?>