<div class="container-fluid py-2">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 bg-light p-3 rounded-3 shadow-sm">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <button onclick="confirmDeleteSelected()"
                    ...
                    <?php if(empty($selectedComments)): ?> disabled <?php endif; ?>>
    ...
    <div class="container px-0">
        <div class="row g-3">
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="col-12">
                    <div class="card comment-card border-0 rounded-3 shadow-sm bg-gradient-card">
                        <div class="card-body p-4 d-flex align-items-center justify-content-between gap-3 flex-wrap">
                            <div class="d-flex align-items-center gap-3">
                                <input type="checkbox" class="form-check-input flex-shrink-0 shadow-sm"
                                    wire:model.live="selectedComments" value="<?php echo e($comment->id); ?>">
                                <div class="flex-grow-1">
                                    <h6 class="mb-1 fw-semibold text-dark"><?php echo e($comment->name ?? 'ناشناس'); ?></h6>
                                    <small class="text-muted d-block"><?php echo e($comment->persian_date); ?></small>
                                </div>
                            </div>
                            <p class="text-muted mb-0 text-ellipsis flex-grow-1" style="max-width: 40%;">
                                <?php echo e(Str::limit($comment->comment, 150)); ?></p>
                            <div class="d-flex align-items-center gap-3">
                                <!--[if BLOCK]><![endif]--><?php if($comment->approve): ?>
                                    ...
                                    <button class="btn btn-outline-primary btn-sm rounded-pill px-3" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#reply-<?php echo e($comment->id); ?>"
                                        aria-expanded="false" aria-controls="reply-<?php echo e($comment->id); ?>">
                                ...
                                <div class="form-check form-switch">
                                    <input type="checkbox" class="form-check-input shadow-sm"
                                        wire:model.live="commentStatuses.<?php echo e($comment->id); ?>"
                                        wire:change="toggleStatus(<?php echo e($comment->id); ?>)" id="status-<?php echo e($comment->id); ?>">
                                    <label class="form-check-label text-muted fw-medium mx-2"
                                        for="status-<?php echo e($comment->id); ?>">
                                        <?php echo e($commentStatuses[$comment->id] ? 'فعال' : 'غیرفعال'); ?>

                                    </label>
                                </div>
                                <a href="<?php echo e(route('admin.content-management.comments.show', $comment->id)); ?>"
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($comment->approve): ?>
                            <div class="collapse" id="reply-<?php echo e($comment->id); ?>">
                                <div class="card-body bg-light p-3 mt-2 rounded-2 shadow-sm">
                                    <p class="text-muted mb-0"><?php echo e($comment->reply); ?></p>
                                </div>
                            </div>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    </div>
...
</div><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/admin/content-management/comment-list.blade.php ENDPATH**/ ?>