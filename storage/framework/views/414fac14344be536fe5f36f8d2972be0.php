<div class="checkbox-wrapper-34">
 <div class="d-flex align-items-center">
  ...
  <input <?php echo e($isChecked ? 'checked' : ''); ?> class='tgl tgl-ios' id='<?php echo e($id); ?>' type='checkbox'>
  <label class='tgl-btn' for='<?php echo e($id); ?>'></label>
  <h6 class="mx-2"><?php echo e($day); ?></h6>
...
<?php /**PATH D:\MyProjects\Benobe\panel\resources\views/components/my-toggle-appointment.blade.php ENDPATH**/ ?>