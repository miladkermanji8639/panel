<div class="container-fluid py-1">
    ...
    <div class="panel-body">
     <div class="form-group">
      ...
      <select class="form-control input-shiny" wire:model.live="selectedTemplateId">
       ...
       <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $allTemplates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
   ...
   <div class="panel panel-default shadow-sm">
    ...
    <div class="panel-body">
     <div class="form-group mb-3">
      ...
      <!--[if BLOCK]><![endif]--><?php if($errors->has('newSubject')): ?>
       <span class="text-danger d-block mt-1"><?php echo e($errors->first('newSubject')); ?></span>
     ...
     <div class="form-group mb-3">
      ...
      <!--[if BLOCK]><![endif]--><?php if($errors->has('newTemplate')): ?>
       <span class="text-danger d-block mt-1"><?php echo e($errors->first('newTemplate')); ?></span>
      <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
     </div>
     <button wire:click="<?php echo e($editId ? 'updateTemplate' : 'addTemplate'); ?>" class="btn btn-gradient-success w-100 py-2">
      <?php echo e($editId ? 'ویرایش' : 'ذخیره تغییرات'); ?>
    ...
    <div class="col-md-6">
     <div class="d-flex gap-2 justify-content-end">
      ...
      <button wire:click="deleteSelected" class="btn btn-gradient-danger rounded-pill px-4"
       <?php if(empty($selectedTemplates)): ?> disabled <?php endif; ?>>
   ...
   <div class="card-body">
    <div class="table-responsive text-nowrap">
     <table class="table table-bordered">
      ...
      <tbody>
       <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <tr>
         <td><input type="checkbox" wire:model.live="selectedTemplates" value="<?php echo e($template->id); ?>"
           class="form-check-input"></td>
         <td><?php echo e($templates->firstItem() + $index); ?></td>
         <td><?php echo e($template->subject); ?></td>
         <td>
          <button wire:click="toggleStatus(<?php echo e($template->id); ?>)"
           class="badge <?php echo e($template->is_active ? 'bg-label-success' : 'bg-label-danger'); ?> border-0 cursor-pointer">
           <?php echo e($template->is_active ? 'فعال' : 'غیرفعال'); ?>

          </button>
         </td>
         <td>
          <div class="d-flex gap-2">
           <button wire:click="startEdit(<?php echo e($template->id); ?>)"
            class="btn btn-gradient-warning rounded-full w-8 h-8 flex items-center justify-center">
            <i class="fas fa-edit"></i>
           </button>
           <button wire:click="previewTemplate(<?php echo e($template->id); ?>)"
            class="btn btn-gradient-primary rounded-full w-8 h-8 flex items-center justify-center">
            <i class="fas fa-eye"></i>
           </button>
           <button onclick="confirmDelete(<?php echo e($template->id); ?>)"
    ...
    <div class="d-flex justify-content-between mt-4">
     <div class="text-muted">نمایش <?php echo e($templates->firstItem()); ?> تا <?php echo e($templates->lastItem()); ?> از
      <?php echo e($templates->total()); ?> ردیف</div>
 ...
 <script>
  document.addEventListener('livewire:init', () => {
   ...
   editor.on('change', (cm) => {
    window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('newTemplate', cm.getValue());
   });
  });
  ...
  function confirmDelete(id) {
   Swal.fire({
    ...
    if (result.isConfirmed) {
     window.Livewire.find('<?php echo e($_instance->getId()); ?>').deleteTemplate(id);
    }
   });
  }
 </script>
</div>
<?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/admin/tools/mail-templates.blade.php ENDPATH**/ ?>