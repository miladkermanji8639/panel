<?php $__env->startSection('title', 'مشاوره ها   '); ?>
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/assets/js/dashboards-crm.js']); ?>
      ...
      <div class="content-wrapper">
        ...
        <div class="flex-grow-1  container-fluid">
          ...
          <h4 class="py-3 mb-4">
            <span class="text-muted fw-light"> مدیریت مشاوره ها  /</span>
          مدیریت مشاوره های کاربران و پزشکان
          </h4>


          <div class="card">
            <div class="card-header">
              <h5 class="card-title mb-0">لیست مشاوره ها  </h5>
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td> 935900	 </td>
                        <td>
                          <span class="badge bg-label-success me-1">بازگشت به کیف پول</span>
                        </td>
                        <td>--</td>
                        <td>0</td>
                        <td>--</td>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              ...
                              <a class="dropdown-item" onclick="location.href='<?php echo e(route('admin.content.doctors.moshavere.edit')); ?>'"
...
<?php echo $__env->make('admin.content.layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/admin/content/doctors/moshavere/index.blade.php ENDPATH**/ ?>