<div>
    <div class="card-header d-flex justify-content-between">
        ...
        <a href="<?php echo e(route('admin.Dashboard.usershipfee.create')); ?>" class="btn btn-primary">
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="<?php echo e(route('admin.Dashboard.usershipfee.edit', $fee->id)); ?>">
                                        <i class="ti ti-pencil me-1"></i> ویرایش
                                    </a>
                                    <button type="button" class="dropdown-item delete" wire:click="confirmDelete(<?php echo e($fee->id); ?>)">
...
</script><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/admin/dashboard/usership/usership-fee-component.blade.php ENDPATH**/ ?>