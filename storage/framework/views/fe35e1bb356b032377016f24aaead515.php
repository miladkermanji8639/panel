                                ...
                                <tr class="transition-all hover:bg-gray-100">
                                    ...
                                    <td class="text-center">
                                        <div class="gateway-logo rounded-circle shadow-sm mx-auto"
                                            style="background-image: asset('dr-assets/icons/newspaper-svgrepo-com.svg'); width: 45px; height: 45px; background-size: cover; background-position: center; border: 3px solid #dee2e6; transition: transform 0.3s ease;"
