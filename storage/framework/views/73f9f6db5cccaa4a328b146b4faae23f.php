    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/assets/js/dashboards-crm.js']); ?>
      ...
      <div class="content-wrapper">
        ...
        <div class="flex-grow-1  container-fluid">
          ...
          <h4 class="py-3 mb-4">
            <span class="text-muted fw-light"> ویدئو صفحه نخست
 /</span>
            لیست ویدئو  ها
          ...
          <div class="card">
            <div class="card-header">
              <h5 class="card-title mb-0">لیست ویدئو صفحه نخست
</h5>
                  ...
                  <div class="me-5 ms-n2 pe-5">
                    <div id="DataTables_Table_0_filter"
                         class="dataTables_filter"><label><input type="search"
                               class="form-control"
                               placeholder="جستجو ویدئو صفحه نخست
"
                      ...
                      <div class="dt-buttons btn-group flex-wrap">
                        <div class="btn-group"><button
                              ...
                              خروجی</span></button></div> <button
                                ...
                                tabindex="0"
                                onclick="location.href='<?php echo e(route('admin.content-management.home-video.create')); ?>'"
                                
                                aria-controls="DataTables_Table_0"
                                type="button"><span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span
                                  class="d-none d-sm-inline-block ">افزودن ویدئو صفحه نخست
 </span></span></button>
                      </div>
                    </div>
                  </div>
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="text-center"><img src="https://benobe.ir/uploads/home_video/1666470870_benobe.png?v=1723707444" class="img-thumbnail" width="85"></td>
                        <td>
                          چرا سامانه نوبت دهی به‌نوبه؟
                        </td>
                        <td>
...
<?php echo $__env->make('admin.content.layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/admin/content/content-management/home-video/index.blade.php ENDPATH**/ ?>