<div class="header d-flex item-center bg-white width-100 custom-border-bottom padding-12-30">
    ...
    <div class="header__left d-flex flex-end item-center margin-top-2">
        <div class="d-flex notif-option">
            ...
            <div class="mx-4 cursor-pointer" onclick="location.href='<?php echo e(route('dr-wallet-charge')); ?>'">
                ...
                <span><?php echo e(number_format($walletBalance)); ?> تومان</span>
            </div>
        </div>
        <a href="<?php echo e(route('dr.auth.logout')); ?>" class="logout" title="خروج"></a>
...
<?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/dr/panel/layouts/partials/header-component.blade.php ENDPATH**/ ?>