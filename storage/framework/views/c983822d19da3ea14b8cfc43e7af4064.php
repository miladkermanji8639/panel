<div class="container-fluid py-5">
    ...
    <header class="glass-header p-4 rounded-3 mb-5 shadow-lg">
        <div class="d-flex align-items-center gap-3">
            ...
            <h4 class="mb-0 fw-bold text-white">افزودن صفحه</h4>
        </div>
    </header>
    ...
    <div class="container px-0">
        <div class="card border-0 rounded-3 shadow-md bg-gradient-card">
            <div class="card-header bg-gradient-primary text-white p-4 rounded-top-3">
                <h5 class="mb-0 fw-bold">افزودن صفحه جدید</h5>
            </div>
...
</div><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/admin/content-management/front-page-create.blade.php ENDPATH**/ ?>