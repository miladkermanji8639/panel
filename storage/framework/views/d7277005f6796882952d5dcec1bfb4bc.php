...
<?php $__env->startSection('bread-crumb-title', ' مدیریت مطب '); ?>
  ...
  <div class="subuser-cards mt-2" id="clinic-list">
   <?php $__empty_1 = true; $__currentLoopData = $clinics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clinic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    <div class="subuser-card p-3 w-100 d-flex justify-content-between align-items-end">
     <div>
      <span class="d-block font-weight-bold text-dark"> <?php echo e($clinic->name); ?></span>
      <span class="font-size-13 font-weight-bold">
       شهر: <span><?php echo e($clinic->city->name); ?></span>
      </span>
      <span class="font-size-13 mx-2 font-weight-bold">
       آدرس:<?php echo e($clinic->address ?? 'نامشخص'); ?>

      </span>
     </div>
     <div>
      <div class="d-flex  gap-4">
       <button class="btn btn-light btn-sm rounded-circle edit-btn" data-id="<?php echo e($clinic->id); ?>">
       ...
       <button class="btn btn-light btn-sm rounded-circle delete-btn" data-id="<?php echo e($clinic->id); ?>">
...
<script>
 ...
 function loadClinics() {
  $.get("<?php echo e(route('dr-clinic-management')); ?>", function(response) {
 ...
 $(document).ready(function() {
  ...
  $(document).on('click', '.edit-btn', function() {
   ...
   $.ajax({
    url: "<?php echo e(route('dr-clinic-edit', ':id')); ?>".replace(':id', clinicId),
    method: 'GET',
    headers: {
  ...
  $('#add-clinic-form').on('submit', function(e) {
   ...
   loader.show();
   $.ajax({
    url: "<?php echo e(route('dr-clinic-store')); ?>",
    method: 'POST',
    data: form.serialize(),
    success: function() {
  ...
  $('#edit-clinic-form').on('submit', function(e) {
   ...
   loader.show();
   $.ajax({
    url: "<?php echo e(route('dr-clinic-update', ':id')); ?>".replace(':id', clinicId),
    method: 'POST',
    data: form.serialize(),
    success: function() {
  ...
  $(document).on('click', '.delete-btn', function() {
   ...
   Swal.fire({
    ...
    if (result.isConfirmed) {
     $.ajax({
      url: "<?php echo e(route('dr-clinic-delete', ':id')); ?>".replace(':id', clinicId),
      method: 'DELETE',
      data: {
...
<?php echo $__env->make('dr.panel.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/dr/panel/doctors-clinic/index.blade.php ENDPATH**/ ?>