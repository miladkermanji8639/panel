    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/assets/js/dashboards-crm.js']); ?>
      ...
      <div class="content-wrapper">
        ...
        <div class="flex-grow-1  container-fluid">
          ...
          <h4 class="py-3 mb-4">
            <span class="text-muted fw-light"> تگ /</span>
            لیست تگ
          </h4>
          ...
          <div class="card">
            <div class="card-header">
              <h5 class="card-title mb-0">لیست تگ</h5>
                      ...
                      <div class="dt-buttons btn-group flex-wrap">
                        <div class="btn-group"><button
                              ...
                              خروجی</span></button></div> <button
                                ...
                                tabindex="0"
                                onclick="location.href='<?php echo e(route('admin.content-management.tags.create')); ?>'"
                                aria-controls="DataTables_Table_0"
                                type="button"><span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span
                                  class="d-none d-sm-inline-block">افزودن تگ </span></span></button>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>آزمایشگاه بیمارستان کوثر سنندج ، شماره تلفن آزمایشگاه بیمارستان کوثر</td>
