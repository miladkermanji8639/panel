            ...
            <div class="card-body p-5">
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <p class="text-muted mb-0 bg-white p-2 rounded-2 shadow-sm"><?php echo e($persianDate); ?></p>
                    </div>
                    <div class="col-md-6">
                        <label class="fw-semibold text-dark mb-2 d-flex align-items-center gap-2">
                            <i class="fas fa-user text-muted"></i> نام
                        </label>
                        <p class="text-muted mb-0 bg-white p-2 rounded-2 shadow-sm"><?php echo e($name ?? 'ناشناس'); ?></p>
                    </div>
                    <div class="col-md-6">
                        <label class="fw-semibold text-dark mb-2 d-flex align-items-center gap-2">
                            <i class="fas fa-envelope text-muted"></i> ایمیل
                        </label>
                        <p class="text-muted mb-0 bg-white p-2 rounded-2 shadow-sm"><?php echo e($email ?? 'نامشخص'); ?></p>
                    </div>
                    <div class="col-md-6">
                        <label class="fw-semibold text-dark mb-2 d-flex align-items-center gap-2">
                            <i class="fas fa-network-wired text-muted"></i> IP
                        </label>
                        <p class="text-muted mb-0 bg-white p-2 rounded-2 shadow-sm"><?php echo e($ip ?? 'نامشخص'); ?></p>
                    </div>
                    <div class="col-md-6">
                        <label class="fw-semibold text-dark mb-2 d-flex align-items-center gap-2">
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control shadow-sm border-0 bg-white" rows="5"
                            readonly><?php echo e($commentText); ?></textarea>
                    </div>
                    <!--[if BLOCK]><![endif]--><?php if($reply): ?>
                        <div class="col-12 mt-3">
                            <label class="fw-semibold text-dark mb-2 d-flex align-items-center gap-2">
                                <i class="fas fa-reply text-muted"></i> پاسخ داده‌شده
                            </label>
                            <div class="bg-success-subtle p-3 rounded-2 shadow-sm">
                                <p class="text-muted mb-0"><?php echo e($reply); ?></p>
                            </div>
                        </div>
            ...
            <div class="card-body p-5">
                <form wire:submit.prevent="saveReply">
                    ...
                    <div class="d-flex justify-content-between align-items-center gap-3">
                        <a href="<?php echo e(route('admin.content-management.comments.index')); ?>"
...
</div><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/admin/content-management/comment-show.blade.php ENDPATH**/ ?>