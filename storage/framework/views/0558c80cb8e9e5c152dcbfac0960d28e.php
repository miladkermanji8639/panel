<blade
       section|(%26%2339%3Btitle%26%2339%3B%2C%20%26%2339%3B%D9%85%D8%AF%DB%8C%D8%B1%DB%8C%D8%AA%20%D9%85%D9%86%D9%88%20%20%20%26%2339%3B)%0D />
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/assets/js/dashboards-crm.js']); ?>
      ...
      <div class="content-wrapper">
        ...
        <div class="flex-grow-1  container-fluid">
          ...
          <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">گزارش کیف پول /</span>
            لیست گزارش کیف پول
          </h4>
          ...
          <div class="card">
            <div class="card-header">
              <h5 class="card-title mb-0">لیست گزارش کیف پول</h5>
                      ...
                      <div class="dt-buttons btn-group flex-wrap">
                        <div class="btn-group"><button
                              ...
                              خروجی</span></button></div> <button
                                ...
                                tabindex="0"
                                onclick="location.href='<?php echo e(route('admin.agent.create')); ?>'"
                                aria-controls="DataTables_Table_0"
                                type="button"><span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span
                                  class="d-none d-sm-inline-block">افزودن گزارش کیف پول </span></span></button>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td> 1403/05/23 14:22 </td>
                        <td>بابت پرداخت حق عضویت کاربر آسوفروتن خرید (حق عضویت 1 ماهه)</td>
                        <td>2,205 تومان</td>
                        <td>
                          <span class="badge bg-label-info me-1">در انتظار درخواست</span>
                        </td>
                        <td>
                          <div class="dropdown">
...
<?php echo $__env->make('admin.content.layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/admin/content/agent/agent_wallet.blade.php ENDPATH**/ ?>