...
<script>
 ...
 $(document).on('click', '#saveSelection', function() {
  ...
  showLoading();
  $.ajax({
   url: "<?php echo e(route('copy-work-hours-counseling')); ?>",
   method: 'POST',
   data: {
 ...
 function reloadDayData(day) {
  $.ajax({
   url: "<?php echo e(route('dr-get-work-schedule-counseling')); ?>",
   method: 'GET',
   data: {
    selectedClinicId: localStorage.getItem('selectedClinicId')
   },
 ...
 $(document).on('click', '#saveSingleSlotSelection', function() {
  ...
  $.ajax({
   url: "<?php echo e(route('copy-single-slot-counseling')); ?>",
   method: 'POST',
   data: {
    source_day: sourceDay,
    target_days: targetDays,
 ...
 $(document).on('click', '[data-target="#scheduleModal"]', function() {
  ...
  $.ajax({
   url: "<?php echo e(route('get-appointment-settings-counseling')); ?>",
   method: 'GET',
   data: {
...
$(document).on("click", ".remove-row-btn", function() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            if (slotId) {
                $.ajax({
                    url: "<?php echo e(route('appointment.slots.destroy-counseling', ':id')); ?>".replace(':id', slotId),
                    method: 'DELETE',
                    data: {
                        _token: '<?php echo e(csrf_token()); ?>',
                        day: day,
 ...
 $(document).ready(function() {
  ...
  function saveWorkSchedule() {
   ...
   // ارسال درخواست AJAX
   $.ajax({
    url: "<?php echo e(route('dr-save-work-schedule-counseling')); ?>",
    method: 'POST',
    data: JSON.stringify({
     ...data,
     selectedClinicId: localStorage.getItem('selectedClinicId')
 ...
 $(document).ready(function() {
  ...
  $.each(["saturday", "sunday", "monday", "tuesday", "wednesday", "thursday", "friday"], function(index, day) {
   $(`#${day}`).on('change', function() {
    ...
    $.ajax({
     url: "<?php echo e(route('update-work-day-status-counseling')); ?>",
     method: 'POST',
     data: {
      day: day,
 ...
 $(document).ready(function() {
  $('#appointment-toggle').on('change', function() {
   ...
   $.ajax({
    url: "<?php echo e(route('update-auto-scheduling-counseling')); ?>",
    method: 'POST',
    data: {
 ...
 $(document).ready(function() {
  ...
  $(document).on("click", "#saveSelectionCalculator", function() {
   ...
   $.ajax({
    url: "<?php echo e(route('save-time-slot-counseling')); ?>",
    method: "POST",
    data: {
     day: day,
     start_time: startTime,
 ...
 function checkAllDaysSettings(day, startTime, endTime, maxAppointments) {
  $.ajax({
   url: "<?php echo e(route('get-all-days-settings-counseling')); ?>",
   method: 'GET',
   data: {
    day: day,
    start_time: startTime,
 ...
 $(document).ready(function() {
  $(document).on('click', '#saveSchedule', function() {
   ...
   $.ajax({
    url: "<?php echo e(route('save-appointment-settings-counseling')); ?>",
    method: 'POST',
    data: {
  ...
  $(document).on('click', '.delete-schedule-setting', function() {
   ...
   Swal.fire({
    ...
    if (result.isConfirmed) {
     $.ajax({
      url: "<?php echo e(route('delete-schedule-setting-counseling')); ?>",
      method: 'POST',
      data: {
       day: day,
...
<?php /**PATH D:\MyProjects\Benobe\panel\resources\views/dr/panel/my-tools/counseling.blade.php ENDPATH**/ ?>