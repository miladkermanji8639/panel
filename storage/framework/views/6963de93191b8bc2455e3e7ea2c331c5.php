...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="col-md-6">
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['alt_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger d-block mt-1"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="col-12 d-flex justify-content-between align-items-center gap-3 mt-4">
                            <a href="<?php echo e(route('admin.questions.question-cat.index')); ?>"
...
</div><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/admin/questions/question-cat-create.blade.php ENDPATH**/ ?>