<div class="container-fluid py-4">
    ...
    <div class="bg-light text-dark p-4 rounded-top border">
        <div class="d-flex align-items-center">
            ...
            <h5 class="mb-0 fw-bold">افزودن دسته‌بندی</h5>
        </div>
    </div>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="d-flex justify-content-between mt-4">
                <a href="<?php echo e(route('admin.content-management.category-blog.index')); ?>" class="btn btn-outline-warning">
...
</div><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/admin/content-management/category-blog-create.blade.php ENDPATH**/ ?>