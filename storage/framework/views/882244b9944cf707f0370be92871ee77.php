...
<head>
 ...
 <link rel="stylesheet" href="<?php echo e(asset('dr-assets/panel/css/doctors-clininc/clinic/cost/cost.css')); ?>">
...
<header class="bg-light text-dark p-3 my-shodow w-100 d-flex align-items-center">
  <div class="back w-50">
    <a href="<?php echo e(route('activation-doctor-clinic', $clinicId)); ?>" class="btn btn-light">
...
<p class="text-center font-weight-bold">
  همکاران شما به‌صورت میانگین مبلغ <?php echo e(number_format($averageDeposit)); ?> تومان را در نظر گرفته‌اند.
</p>

     <form id="depositForm">
      <?php echo csrf_field(); ?>
         <input type="hidden" name="clinic_id" value="<?php echo e($clinicId); ?>"> <!-- شناسه مطب -->
         <input type="hidden" name="doctor_id" value="<?php echo e($doctorId); ?>"> <!-- شناسه دکتر -->
...
<script>
 ...
 function loadDeposits() {
  fetch("<?php echo e(route('cost.list', ['clinic_id' => $clinicId])); ?>")
 ...
 function deleteDeposit(id) {
  Swal.fire({
   ...
   if (result.isConfirmed) {
    fetch("<?php echo e(route('cost.delete')); ?>", {
     method: "POST",
     headers: {
 ...
 document.addEventListener("DOMContentLoaded", loadDeposits);
  ...
  document.getElementById('depositAmount').addEventListener('change', function () {
   ...
   document.getElementById('saveButton').addEventListener('click', function () {
      ...
      fetch("<?php echo e(route('cost.store')); ?>", {
        method: "POST",
        headers: {
          "X-CSRF-TOKEN": document.querySelector('input[name="_token"]').value,
        },
        ...
        .then(data => {
          if (data.success) {
            ...
            loadDeposits();
            location.href = "<?php echo e(route('duration.index', $clinicId)); ?>";
          } else {
            Swal.fire({
              icon: "error",
              title: "خطا",
...
</html><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/dr/panel/doctors-clinic/activation/cost/index.blade.php ENDPATH**/ ?>