<?php $__env->startSection('title', 'نمایندگان   '); ?>
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/assets/js/dashboards-crm.js']); ?>
      ...
      <div class="content-wrapper">
        ...
        <div class="flex-grow-1  container-fluid">
          ...
          <h4 class="py-3 mb-4">
            <span class="text-muted fw-light"> نمایندگان /</span>
            لیست نمایندگان
          </h4>
          ...
          <div class="card">
            <div class="card-header">
              <h5 class="card-title mb-0">لیست نمایندگان</h5>
                        ...
                        <div class="btn-group"><button
                              ...
                              خروجی</span></button></div> <button
                                ...
                                type="button"><span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span
                                  class="d-none d-sm-inline-block">افزودن نماینده </span></span></button>
                      </div>
                    </div>
                  </div>
                </div>
...
<?php echo $__env->make('admin.content.layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/admin/content/agent/agent.blade.php ENDPATH**/ ?>