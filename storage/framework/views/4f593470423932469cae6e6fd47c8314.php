...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="col-md-6">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($existingVideo): ?>
                                <div class="mb-2">
                                    <video controls class="w-100" style="max-height: 100px;">
                                        <source src="<?php echo e(asset('storage/' . $existingVideo)); ?>" type="video/mp4">
                                    </video>
                                </div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
...
</div><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/admin/content-management/home-video-edit.blade.php ENDPATH**/ ?>