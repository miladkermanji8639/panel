<div class="container-fluid py-2">
    ...
    <header class="glass-header p-4 rounded-3 mb-2 shadow-lg">
        <div class="d-flex align-items-center justify-content-between gap-3">
            <div class="d-flex align-items-center gap-3">
                <i class="fas fa-file-alt fs-4 text-white animate-bounce"></i>
                <h4 class="mb-0 fw-bold text-white">لیست صفحات</h4>
            </div>
        </div>
    </header>
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="input-group" style="max-width: 350px;">
                    ...
                    <input type="text" class="form-control border-0 shadow-none" wire:model.live="search"
                        placeholder="جستجو در عنوان صفحه">
                </div>
            </div>
            <div class="d-flex align-items-center gap-3">
                ...
                <button onclick="confirmDeleteSelected()"
                    ...
                    <?php if(empty($selectedPages)): ?> disabled <?php endif; ?>>
                    <i class="fas fa-trash fs-6"></i> حذف انتخاب‌شده‌ها
                </button>
                <a href="<?php echo e(route('admin.content-management.front-pages.create')); ?>"
                    class="btn btn-gradient-success rounded-pill px-4 py-2 d-flex align-items-center gap-2">
                    <i class="fas fa-plus fs-6"></i> افزودن صفحه
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="container px-0">
        <div class="row g-3">
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="col-12">
                        ...
                        <div class="card-body p-4 d-flex align-items-center justify-content-between gap-3 flex-wrap">
                            <div class="d-flex align-items-center gap-3">
                                <input type="checkbox" class="form-check-input flex-shrink-0 shadow-sm"
                                    wire:model.live="selectedPages" value="<?php echo e($page->id); ?>">
                                <div class="flex-grow-1">
                                    <h6 class="mb-1 fw-semibold text-dark">
                                        <i class="ti ti-eye me-2"></i><?php echo e($page->title); ?>

                                    </h6>
                                    <small class="text-muted d-block"><?php echo e($page->persian_date); ?></small>
                                </div>
                            </div>
                            <div class="d-flex align-items-center gap-3">
                                <div class="form-check form-switch">
                                    <input type="checkbox" class="form-check-input shadow-sm"
                                        wire:model.live="pageStatuses.<?php echo e($page->id); ?>"
                                        wire:change="toggleStatus(<?php echo e($page->id); ?>)" id="status-<?php echo e($page->id); ?>">
                                    <label class="form-check-label text-muted fw-medium mx-2" for="status-<?php echo e($page->id); ?>">
                                        <?php echo e($pageStatuses[$page->id] ? 'فعال' : 'غیرفعال'); ?>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end shadow-sm rounded-3">
                                        <a class="dropdown-item d-flex align-items-center gap-2"
                                            href="<?php echo e(route('admin.content-management.front-pages.edit', $page->id)); ?>">
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="col-12">
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted fw-medium">هیچ صفحه‌ای یافت نشد.</p>
                    </div>
                </div>
    ...
    <script>
        ...
        function confirmDeleteSelected() {
            Swal.fire({
                ...
                text: 'صفحات انتخاب‌شده حذف خواهند شد و قابل بازگشت نیستند!',
                icon: 'warning',
...
</div><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/admin/content-management/front-page-list.blade.php ENDPATH**/ ?>