  ...
  <header class="glass-header p-3 rounded-3 mb-2 shadow-lg">
   <div class="d-flex align-items-center justify-content-between gap-3">
    <div class="d-flex align-items-center gap-2">
     ...
     <h4 class="mb-0 fw-bold text-white">گزارش مشاوره پزشکان</h4>
    </div>
   ...
   <div class="row g-3 align-items-center">
    ...
    <div class="col-md-6 col-sm-12 d-flex justify-content-end gap-2">
     ...
     <button wire:click="deleteSelected" class="btn btn-outline-danger rounded-pill px-3"
      <?php if(empty($selectedAppointments)): ?> disabled <?php endif; ?>>
  ...
  <div class="card shadow-sm">
   <div class="card-body p-3">
     ...
     <table class="table table-bordered table-striped table-sm">
      <thead>
       <tr>
        ...
        <!-- فیلدهای جدید -->
        <th style="width: 6%;">مبلغ (تومان)</th>
        <th style="width: 6%;">مدت زمان (دقیقه)</th>
        <th style="width: 8%;">زمان تماس</th>
        <th style="width: 6%;">وضعیت تسویه</th>
      ...
      <tbody>
       <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <td>
                <span class="badge 
                <?php echo e($appointment->status === 'scheduled'
            ? 'bg-label-info'
            ...
            : ($appointment->status === 'cancelled'
             ...
             <!-- فیلدهای جدید -->
             <td><?php echo e($appointment->fee ? number_format($appointment->fee) : '0'); ?></td>
             <td><?php echo e($appointment->duration ?? '0'); ?></td>
             <td>
              <?php echo e($appointment->confirmed_at ? \App\Helpers\JalaliHelper::toJalaliDateTime($appointment->confirmed_at) : '---'); ?>

             </td>
             <td>
              <span
               class="badge 
                        <?php echo e($appointment->payment_status === 'paid'
            ? 'bg-label-success'
            ...
            ->exists();
                ...
                <li class="dropdown-submenu">
                 ...
                 <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="#"
                    wire:click.prevent="changeStatus(<?php echo e($appointment->id); ?>, 'pending_review')">در انتظار بررسی
                    و تماس</a></li>
                  <li><a class="dropdown-item" href="#"
                    wire:click.prevent="changeStatus(<?php echo e($appointment->id); ?>, 'call_answered')">تماس پاسخ داده
                    شده</a></li>
                  <li><a class="dropdown-item" href="#"
                    wire:click.prevent="changeStatus(<?php echo e($appointment->id); ?>, 'call_completed')">مکالمه انجام و
                    پایان یافته است</a></li>
                  <li><a class="dropdown-item" href="#"
                    wire:click.prevent="changeStatus(<?php echo e($appointment->id); ?>, 'refunded')">بازگشت به کیف پول</a>
                  </li>
                  <li><a class="dropdown-item" href="#"
                    wire:click.prevent="changeStatus(<?php echo e($appointment->id); ?>, 'missed')">عدم پاسخگویی</a></li>
                 </ul>
                </li>
               </ul>
              </div>
    ...
    <div class="d-flex justify-content-between mt-3">
     <div class="text-muted fs-6">نمایش <?php echo e($appointments->firstItem()); ?> تا <?php echo e($appointments->lastItem()); ?> از
      <?php echo e($appointments->total()); ?> ردیف</div>
...
<?php /**PATH D:\MyProjects\Benobe\panel\resources\views/livewire/admin/doctors/doctor-counseling-logs.blade.php ENDPATH**/ ?>