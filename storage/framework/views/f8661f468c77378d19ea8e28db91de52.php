     ...
     <div class="col-md-6 login-container position-relative">
      <div class="login-card custom-rounded custom-shadow p-7">
       ...
       <form id="login-form-step1" method="POST">
        ...
        <a href="<?php echo e(route('admin.auth.login-user-pass-form')); ?>"
    ...
    <div class="justify-content-center align-items-center">
     <div class="col-md-6 login-container position-relative">
      <div class="login-card custom-rounded custom-shadow p-7">
       ...
       <form id="otp-form" method="POST" action="<?php echo e(route('admin.auth.login-confirm', ['token' => $token])); ?>">
        <?php echo csrf_field(); ?>
        ...
        <section id="resend-otp" class="d-none mt-2">
         <a href="<?php echo e(route('admin.auth.login-resend-otp', $token)); ?>"
    ...
    <div class="justify-content-center align-items-center">
     <div class="col-md-6 login-container position-relative">
      <div class="login-card custom-rounded custom-shadow p-7">
       ...
       <form id="login-with-pass-form" method="POST" action="<?php echo e(route('admin-login-with-mobile-pass')); ?>">
        <?php echo csrf_field(); ?>
        <div class="mb-3">
         <div class="d-flex align-items-center mb-2">
          <img src="<?php echo e(asset('dr-assets/login/images/phone.svg')); ?>" alt="Phone Icon" class="me-2">
    ...
    <div class="justify-content-center align-items-center">
     <div class="col-md-6 login-container position-relative">
      <div class="login-card custom-rounded custom-shadow p-7">
       ...
       <form id="two-factor-check-form" method="POST" action="<?php echo e(route('admin-two-factor-store')); ?>">
        <?php echo csrf_field(); ?>
        <div class="mb-3">
         <div class="d-flex align-items-center mb-2">
          <img src="<?php echo e(asset('dr-assets/login/images/password.svg')); ?>" alt="Password Icon" class="me-2">
 ...
 <script>
  ...
  $(document).ready(function() {
   ...
   $('#resend-otp').on('click', function(e) {
    ...
    $.ajax({
     url: "<?php echo e(route('admin.auth.login-resend-otp', ['token' => ':token'])); ?>".replace(':token', token),
     method: 'GET',
   ...
   $('.go-back').on('click', function() {
    ...
    if (currentStep > 1) { // ریست کردن تایمر
     window.location.href = "<?php echo e(route('admin.auth.login-register-form')); ?>?step=" + (currentStep - 1);
    }
   });
   // متغیرهای عمومی
   ...
   $('#login-form-step1').on('submit', function(e) {
    ...
    $.ajax({
     url: "<?php echo e(route('admin.auth.login-register')); ?>",
     method: 'POST',
     data: form.serialize(),
     success: function(response) {
      toastr.success("کد تایید با موفقیت ارسال شد");
      window.location.href = "<?php echo e(route('admin.auth.login-confirm-form', ['token' => ':token'])); ?>".replace(
...
<?php echo $__env->make('dr.layouts.master-login', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/admin/content/authentications/auth-login-basic.blade.php ENDPATH**/ ?>