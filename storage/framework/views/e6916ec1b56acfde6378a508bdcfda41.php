...
<?php $__env->startSection('bread-crumb-title', 'شارژ کیف پول'); ?>
 <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('dr.wallet-charge-component', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-4088449351-0', $__slots ?? [], get_defined_vars());
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dr.panel.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\MyProjects\Benobe\panel\resources\views/dr/panel/payment/charge.blade.php ENDPATH**/ ?>