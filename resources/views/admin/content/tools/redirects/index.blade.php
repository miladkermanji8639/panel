    ...
    @vite(['resources/assets/js/dashboards-crm.js'])
      ...
      <div class="content-wrapper">
        ...
        <div class="flex-grow-1  container-fluid">
          ...
          <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">  Redirects
              /</span>
            لیست  Redirects
          ...
          <div class="card">
            <div class="card-header">
              <h5 class="card-title mb-0">لیست  Redirects
              </h5>
                      ...
                      <div class="dt-buttons btn-group flex-wrap">
                        <div class="btn-group"><button
                              ...
                              خروجی</span></button></div> <button
                                ...
                                tabindex="0"
                                onclick="location.href='{{ route('admin.tools.redirects.create') }}'"
                                aria-controls="DataTables_Table_0"
                                type="button"><span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span
                                  class="d-none d-sm-inline-block ">افزودن  Redirects
                            </span></span></button>
                      </div>
                    </div>
                  </div>
                  ...
                  <table class="table table-bordered">
                    <thead>
                      <tr>
                        ...
                        <th> ردیف</th>
                        <th> آدرس مسیر redirect </th>
                        <th> آدرس هدف redirect </th>
                        <th>وضعیت</th>
                        <th>عملیات</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        ...
                        <td>
                         /blog/86-nvbt-dhy-klynyk-frhngyan-mryvan.html

                        </td>
                        <td>
                         https://benobe.ir/blog/87-nvbt-dhy-klynyk-frhngyan-mryvan.html
                          ...
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item"
                                 onclick="location.href='{{ route('admin.questions.question.show') }}'"
