    ...
    @vite(['resources/assets/js/dashboards-crm.js'])
      ...
      <div class="content-wrapper">
        ...
        <div class="flex-grow-1  container-fluid">
          ...
          <h4 class="py-3 mb-4">
            <span class="text-muted fw-light"> اعضای خبرنامه
              /</span>
            لیست اعضای خبرنامه
          ...
          <div class="card">
            <div class="card-header">
              <h5 class="card-title mb-0">لیست اعضای خبرنامه
              </h5>
                  ...
                  <div class="me-5 ms-n2 pe-5">
                    <div id="DataTables_Table_0_filter"
                         class="dataTables_filter"><label><input type="search"
                               class="form-control"
                               placeholder="جستجو اعضای خبرنامه  
"
                        ...
                        <div class="btn-group"><button
                              ...
                              خروجی</span></button></div> <button
                                ...
                                type="button"><span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span
                                  class="d-none d-sm-inline-block ">افزودن اعضای خبرنامه
                            </span></span></button>
                      </div>
                    </div>
                  </div>
