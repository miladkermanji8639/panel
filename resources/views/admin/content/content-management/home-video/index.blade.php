                      ...
                      <div class="dt-buttons btn-group flex-wrap">
                        <div class="btn-group"><button
                              ...
                              خروجی</span></button></div> <button
                                ...
                                tabindex="0"
                                onclick="location.href='{{ route('admin.content-management.home-video.create') }}'"
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" onclick="location.href='{{ route('admin.content-management.comments.show') }}'"
