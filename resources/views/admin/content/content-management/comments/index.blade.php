    ...
    @vite(['resources/assets/js/dashboards-crm.js'])
      ...
      <div class="content-wrapper">
        ...
        <div class="flex-grow-1  container-fluid">
          ...
          <h4 class="py-3 mb-4">
            <span class="text-muted fw-light"> نظرات /</span>
            لیست نظرات
          </h4>
                        ...
                        <div class="btn-group"><button
                              ...
                              خروجی</span></button></div> <button
                                ...
                                type="button"><span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span
                                  class="d-none d-sm-inline-block ">افزودن نظرات </span></span></button>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td> 
                          مولود یوسفی </td>
                          <td> 
                          نوبت دهی دکتر لطف الله ساعد </td>
                          <td> 
                           نوبت می خواستم ‌‌ازکامیاران وضع جسمانی تعریفی ندارد19 </td>
                          <td> 
                          0 </td>
