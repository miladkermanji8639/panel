                            ...
                            <div
                                ...
                                <div class="dt-buttons btn-group flex-wrap">
                                    <div class="btn-group"><button
                                            ...
                                            tabindex="0"
                                            onclick="location.href='{{ route('admin.Dashboard.cities.create-city') }}'"
                                            aria-controls="DataTables_Table_0"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span id="{{ $city->id }}"
                                              ...
                                              class="cursor-pointer badge bg-label-{{ $city->status==1 ? 'success':'danger' }} me-1"
                                              {{
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                   onclick="location.href='{{ url('admin/dashboard/cities/edit-city/'.$city->id) }}'"
                                                ...
                                                <form method="POST"
                                                      class=""
                                                      action="{{ url('admin/dashboard/cities/delete-city/'.$city->id) }}">
                                                    {{ csrf_field() }}
                                                    {{ method_field('DELETE') }}
                                                    <button type="submit"
