    ...
    @vite(['resources/assets/js/dashboards-crm.js'])
      ...
      <div class="content-wrapper">
        ...
        <div class="flex-grow-1  container-fluid">
          ...
          <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">تعرفه ها /</span>
            لیست تعرفه ها
          </h4>
                      ...
                      <div class="dt-buttons btn-group flex-wrap">
                        <div class="btn-group"><button
                              ...
                              خروجی</span></button></div> <button
                                ...
                                tabindex="0"
                                onclick="location.href='{{ route('admin.Dashboard.membershipfee.create') }}'"
                                aria-controls="DataTables_Table_0"
                                type="button"><span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span
                                  class="d-none d-sm-inline-block">افزودن تعرفه </span></span></button>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          ...
                          <span class="fw-medium"> بسته سه ماهه</span>
                        </td>
                        <td> یکشنبه</td>

                        <td>
                          <span class="badge bg-label-info me-1">50000</span>
                        </td>
                        <td>
                          <div class="dropdown">
