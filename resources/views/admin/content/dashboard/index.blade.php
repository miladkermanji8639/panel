     ...
     <ul class="p-0 m-0">
      ...
      <li class="d-flex mb-4 pb-2 align-items-center">
       <img alt="سياحت اکتشافی" class="me-3 rounded" height="28"
        src="{{ asset('assets/img/icons/brands/safari.png') }}" />
       <div class="d-flex w-100 align-items-center gap-2">
        <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
         <div>
      ...
      <li class="d-flex mb-4 pb-2 align-items-center">
       <img alt="فایرفاکس" class="me-3 rounded" height="28"
        src="{{ asset('assets/img/icons/brands/firefox.png') }}" />
       <div class="d-flex w-100 align-items-center gap-2">
        <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
         <div>
      ...
      <li class="d-flex mb-4 pb-2 align-items-center">
       <img alt="اپرا" class="me-3 rounded" height="28"
        src="{{ asset('assets/img/icons/brands/opera.png') }}" />
       <div class="d-flex w-100 align-items-center gap-2">
        <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
         <div>
      ...
      <li class="d-flex mb-4 pb-2 align-items-center">
       <img alt="لبه" class="me-3 rounded" height="28"
        src="{{ asset('assets/img/icons/brands/edge.png') }}" />
       <div class="d-flex w-100 align-items-center gap-2">
        <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
         <div>
      ...
      <li class="d-flex align-items-center">
       <img alt="شجاع" class="me-3 rounded" height="28"
        src="{{ asset('assets/img/icons/brands/brave.png') }}" />
       <div class="d-flex w-100 align-items-center gap-2">
        <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
         <div>
     ...
     <ul class="p-0 m-0">
      <li class="mb-3 pb-1 d-flex">
       <div class="d-flex w-50 align-items-center me-3">
        <img alt="آرم لاراول" class="me-3" src="{{ asset('assets/img/icons/brands/laravel-logo.png') }}"
         width="35" />
        <div>
      ...
      <li class="mb-3 pb-1 d-flex">
       <div class="d-flex w-50 align-items-center me-3">
        <img alt="لوگوی فیگما" class="me-3" src="{{ asset('assets/img/icons/brands/figma-logo.png') }}"
         width="35" />
        <div>
      ...
      <li class="mb-3 pb-1 d-flex">
       <div class="d-flex w-50 align-items-center me-3">
        <img alt="لوگوی وو" class="me-3" src="{{ asset('assets/img/icons/brands/vue-logo.png') }}"
         width="35" />
        <div>
      ...
      <li class="mb-3 pb-1 d-flex">
       <div class="d-flex w-50 align-items-center me-3">
        <img alt="آرم راکت" class="me-3" src="{{ asset('assets/img/icons/brands/react-logo.png') }}"
         width="35" />
        <div>
      ...
      <li class="mb-3 pb-1 d-flex">
       <div class="d-flex w-50 align-items-center me-3">
        <img alt="آرم بوت استرپ" class="me-3" src="{{ asset('assets/img/icons/brands/bootstrap-logo.png') }}"
         width="35" />
        <div>
      ...
      <li class="d-flex">
       <div class="d-flex w-50 align-items-center me-3">
        <img alt="لوگوی طرح" class="me-3" src="{{ asset('assets/img/icons/brands/sketch-logo.png') }}"
         width="35" />
        <div>
         ...
         <div class="d-flex justify-content-start align-items-center">
          <div class="me-3">
           <img alt="ویزا" height="30"
            src="{{ asset('assets/img/icons/payments/american-express-img.png') }}" />
          </div>
          <div class="d-flex flex-column">
           <p class="mb-0 fw-medium">
            <bdi>*4567</bdi>
