        ...
        <div class="d-flex justify-content-between">
            <div>
                <h4 class="py-3 mb-4">
                    ...
                    لیست تخصص های مرتبط با {{ $specialtyName[0]->name }}
                </h4>
            </div>
            <div>
                            ...
                            <div
                                ...
                                <div class="dt-buttons btn-group flex-wrap">
                                    <div class="btn-group"><button
                                            ...
                                            tabindex="0"
                                            onclick="location.href='{{ route('admin.Dashboard.specialty.create-specialty') }}'"
                                            aria-controls="DataTables_Table_0"
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                   onclick="location.href='{{ url('admin/dashboard/specialty/edit-specialty/'.$specialty->id) }}'"
                                                ...
                                                <form method="POST"
                                                      class=""
                                                      action="{{ url('admin/dashboard/specialty/delete-specialty/'.$specialty->id) }}">
                                                    {{ csrf_field() }}
                                                    {{ method_field('DELETE') }}
                                                    <button type="submit"
