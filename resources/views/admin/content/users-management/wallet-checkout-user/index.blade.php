...
@section('title', ' درخواست های تسویه حساب کیف پول پزشکان    ')
    ...
    @vite(['resources/assets/js/dashboards-crm.js'])
      ...
      <div class="content-wrapper">
        ...
        <div class="flex-grow-1  container-fluid">
          ...
          <h4 class="py-3 mb-4">
            <span class="text-muted fw-light"> مدیریت درخواست های تسویه حساب کیف پول پزشکان   /</span>
          ...
          <div class="card">
            <div class="card-header">
              <h5 class="card-title mb-0">لیست  درخواست های تسویه حساب کیف پول پزشکان  </h5>
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td> 		  1403/05/26 14:09	  </td>
                        <td> 	محمد سامی اداک</td>
                        <td><span class="badge bg-label-primary me-1">در انتظار پرداخت</span></td>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              ...
                              <a class="dropdown-item" onclick="location.href='{{ route('admin.content.users-management.wallet-checkout-user.show') }}'"
                                 href="javascript:void(0);">
                                <i class="ti ti-eye me-1"></i>
                                جزییات کیف پول کاربر
                              </a>
                              <a class="dropdown-item" onclick="location.href='{{ route('admin.content.users-management.wallet-checkout-user.edit') }}'"
                                 href="javascript:void(0);">
