...
@section('title', '  درخواست های تسویه حساب کیف پول منشی   ')
    ...
    @vite(['resources/assets/js/dashboards-crm.js'])
      ...
      <div class="content-wrapper">
        ...
        <div class="flex-grow-1  container-fluid">
          ...
          <h4 class="py-3 mb-4">
            <span class="text-muted fw-light"> مدیریت درخواست های تسویه حساب کیف پول منشی   /</span>
          ...
          <div class="card">
            <div class="card-header">
              <h5 class="card-title mb-0">لیست  درخواست های تسویه حساب کیف پول منشی  </h5>
