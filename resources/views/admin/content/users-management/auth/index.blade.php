    ...
    @vite(['resources/assets/js/dashboards-crm.js'])
      ...
      <div class="content-wrapper">
        ...
        <div class="flex-grow-1  container-fluid">
          ...
          <h4 class="py-3 mb-4">
            <span class="text-muted fw-light"> احراز هویت    /</span>
          تایید و احراز هویت کاربران   
          </h4>
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <tr>
                       ...
                       <td><img src="http://placehold.it/32x32/ccc/333.png?text=Avatar" class="img-responsive img-circle" style="width:32px; height:32px;"></td>
                       <td>
                          <span class="badge bg-label-warning me-1">پزشکان</span>
                        </td>
                        <td> 	محمد سامی اداک</td>
                        <td>09397947829</td>

                        <td>
                          <span class="badge bg-label-danger me-1">در انتظار تایید</span>
                        </td>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              ...
                              <a class="dropdown-item" onclick="location.href='{{ route('admin.content.users-management.auth.show') }}'"
