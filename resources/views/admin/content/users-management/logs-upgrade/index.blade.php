    ...
    @vite(['resources/assets/js/dashboards-crm.js'])
      ...
      <div class="content-wrapper">
        ...
        <div class="flex-grow-1  container-fluid">
          ...
          <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">  گزارشات پرداخت های ارتقا حساب کاربری   /</span>
          ...
          <div class="card">
            <div class="card-header">
              <h5 class="card-title mb-0">لیست  گزارشات پرداخت های ارتقا حساب کاربری  </h5>
