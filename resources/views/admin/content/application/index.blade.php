...
@section('title', 'صفحه نخست اپلیکیشن    ')
    ...
    @vite(['resources/assets/js/dashboards-crm.js'])
      ...
      <div class="content-wrapper">
        ...
        <div class="flex-grow-1  container-fluid">
          ...
          <h4 class="py-3 mb-4">
            <span class="text-muted fw-light"> صفحه نخست اپلیکیشن  /</span>
        طراحی و چینش آیتم ها و بلوک ها
          </h4>


          <div class="card">
            <div class="card-header">
              <h5 class="card-title mb-0">لیست  چینش  </h5>
                      ...
                      <div class="dt-buttons btn-group flex-wrap">
                        <div class="btn-group"><button
                              ...
                              <button
                                ...
                                tabindex="0"
                                onclick="location.href='{{ route('admin.content.application.create') }}'"
                                aria-controls="DataTables_Table_0"
                                type="button"><span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span
                                  class="d-none d-sm-inline-block">افزودن تنظیمات </span></span></button>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td width="100"><input type="text" class="ltr form-control text-center" name="sort[4]" value="0"></td>
                        <td> کودکان</td>
                        <td class="text-center"><img src="https://benobe.ir/uploads/noicon.png" class="img-responsive" width="40"> </td>
                        <td>8</td>
                        <td>
