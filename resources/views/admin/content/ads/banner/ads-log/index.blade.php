...
@section('title', 'گزارش پرداخت های آنلاین تبلیغات')
...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="flex-grow-1  container-fluid">
            ...
            <h4 class="py-3 mb-4">
                <span class="text-muted fw-light">  گزارش پرداخت های آنلاین تبلیغات   /</span>
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">لیست گزارش پرداخت های آنلاین تبلیغات </h5>
                                        ...
                                        <div class="btn-group">
                                            <button
                                                    ...
                                                    aria-expanded="false"><span><i
                                                            class="ti ti-download me-1 ti-xs"></i>گرفتن
                              خروجی</span></button>
                                        </div>
                        ...
                        <div class="table-responsive text-nowrap fs-6">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>1401/02/24 23:12</td>
                                    <td>مهران حسيني</td>
                                    <td>09183715853</td>
                                    <td>Mehraan_hosseini@yahoo.com</td>
                                    <td>34180200001</td>
                                    <td> 1,671,000</td>
                                    <td>پنل طلایی</td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item"
                                                   onclick="location.href='{{ route('admin.content.users-management.user-group.edit') }}'"
                        ...
                        <div class="row mx-2 mt-4">
                            <div class="col-sm-12 col-md-6">
                                <div class="dataTables_info"
                                     ...
                                     role="status"
                                     aria-live="polite">نمایش 1 تا 7 از 100 ردیف
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-6 ">
