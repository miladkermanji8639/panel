    ...
    @vite(['resources/assets/js/dashboards-crm.js'])
      ...
      <div class="content-wrapper">
        ...
        <div class="flex-grow-1  container-fluid">
          ...
          <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">   مدیریت پکیج ها  /</span>
          ...
          <div class="card">
            <div class="card-header">
              <h5 class="card-title mb-0"> لیست پکیج ها  </h5>
                      ...
                      <div class="dt-buttons btn-group flex-wrap">
                        <div class="btn-group"><button
                              ...
                              <button
                                ...
                                tabindex="0"
                                onclick="location.href='{{ route('admin.content.ads.banner.packages.create') }}'"
                                aria-controls="DataTables_Table_0"
                                type="button"><span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span
                                  class="d-none d-sm-inline-block">افزودن پکیج جدید </span></span></button>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              ...
                              <a class="dropdown-item" onclick="location.href='{{ route('admin.content.ads.banner.packages.edit') }}'"
