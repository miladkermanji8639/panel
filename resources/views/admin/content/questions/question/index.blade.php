    ...
    @vite(['resources/assets/js/dashboards-crm.js'])
      ...
      <div class="content-wrapper">
        ...
        <div class="flex-grow-1  container-fluid">
          ...
          <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">   پرسش و پاسخ
 /</span>
            لیست پرسش و پاسخ  
          ...
          <div class="card">
            <div class="card-header">
              <h5 class="card-title mb-0">لیست پرسش و پاسخ  
</h5>
                      ...
                      <div class="dt-buttons btn-group flex-wrap">
                        <div class="btn-group"><button
                              ...
                              خروجی</span></button></div> <button
                                class="btn btn-secondary add-new btn-primary ms-2 ms-sm-0 waves-effect waves-light disabled"
                                tabindex="0"
                                ...
                                type="button"><span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span
                                  class="d-none d-sm-inline-block ">افزودن پرسش و پاسخ  
 </span></span></button>
                      </div>
                    </div>
                  </div>
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          سلام وقت بخیر 38 سالمه و منییر گوش دارم درصد کمی شنوایی از دست دادم به صداهای بلند حالم بد میشه گوشم درد میگیره سرگیجه میگیرم فشار از پشت گوش تا پشت سر بعضی وقت ها تا مرکز سر درد میگیره و خیلی گیج میشم همه اش خواب میرم برای سرگیجه قرص خوردم فایده نداشت بهتر نشدم بدترشدم لطفا راهنمایی فرمایید
                        </td>
                        <td>
                          طاهره دانائی فرد
                        </td>
                        ...
                        <td>
                          <span class="badge bg-label-danger me-1">منتشر نشده</span>
                        </td>
