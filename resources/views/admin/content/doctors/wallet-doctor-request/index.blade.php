                        ...
                        <div class="btn-group"><button
                              ...
                              خروجی</span></button></div> <button
                                ...
                                type="button"><span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span
                                  class="d-none d-sm-inline-block">افزودن درخواست </span></span></button>
                      </div>
                    </div>
                  </div>
                </div>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" onclick="location.href='{{ route('admin.content.doctors.wallet-doctor-request.show') }}'"
