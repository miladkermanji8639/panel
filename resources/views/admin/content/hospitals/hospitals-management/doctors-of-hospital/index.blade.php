...
@section('title', 'پزشکان کلینیک هیرو    ')
    ...
    @vite(['resources/assets/js/dashboards-crm.js'])
      ...
      <div class="content-wrapper">
        ...
        <div class="flex-grow-1  container-fluid">
          ...
          <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">   پزشکان کلینیک هیرو  /</span>
          </h4>


          <div class="card">
            <div class="card-header">
              <h5 class="card-title mb-0">لیست  پزشکان کلینیک هیرو   </h5>
                      ...
                      <div class="dt-buttons btn-group flex-wrap">
                        <div class="btn-group"><button
                              ...
                              <button
                                ...
                                tabindex="0"
                                onclick="location.href='{{ route('admin.content.hospitals.hospitals-management.doctors-of-hospital.create') }}'"
                                aria-controls="DataTables_Table_0"
