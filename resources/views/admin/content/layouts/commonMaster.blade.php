...
<head>
 ...
 <link rel="stylesheet" href="{{ asset('admin-assets/tailwind/tailwind.min.css') }}" />
 <link rel="stylesheet" href="{{ asset('admin-assets/custom/custom.css') }}" />
 <link rel="stylesheet" href="{{ asset('admin-assets/custom-datepicker/custom-datepicker.css') }}" />
 ...
 @include('admin.content.layouts/sections/styles' . $isFront)

 <!-- Include Scripts for customizer, helper, analytics, config -->
 <!-- $isFront is used to append the front layout scriptsIncludes only on the front layout otherwise the variable will be blank -->
 @include('admin.content.layouts/sections/scriptsIncludes' . $isFront)
...
<script src="{{ asset('admin-assets/js/codemirror/5.65.7/codemirror.min.js') }}"></script>
<script src="{{ asset('admin-assets/js/codemirror/5.65.7/mode/htmlmixed/htmlmixed.min.js') }}"></script>
<script src="{{ asset('admin-assets/custom-datepicker/custom-datepicker.js') }}"></script>
<!-- اضافه شده برای دیت‌پیکر -->
<script>
