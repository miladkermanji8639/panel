    ...
    <div class="dropdown-shortcuts-list scrollable-container">
     <div class="row row-bordered overflow-visible g-0">
      <div class="dropdown-shortcuts-item col">
       ...
       <a class="stretched-link mb-0" href="{{ route('admin.Dashboard.holiday.index') }}">روز های تعطیل سال</a>
      ...
      <div class="dropdown-shortcuts-item col">
       ...
       <a class="stretched-link mb-0" href="{{ route('admin.content-management.comments.index') }}">نظرات کاربران</a>
     ...
     <div class="row row-bordered overflow-visible g-0">
      <div class="dropdown-shortcuts-item col">
       ...
       <a class="stretched-link mb-0" href="{{ route('admin.content.users-management.users.index') }}">کاربران</a>
      ...
      <div class="dropdown-shortcuts-item col">
       ...
       <a class="stretched-link mb-0" href="{{ route('admin.content.hospitals.hospitals-management.index') }}">
        بیمارستان</a>
     ...
     <div class="row row-bordered overflow-visible g-0">
      <div class="dropdown-shortcuts-item col">
       ...
       <a class="stretched-link mb-0" href="{{ route('admin.index') }}">داشبورد</a>
      ...
      <div class="dropdown-shortcuts-item col">
       ...
       <a class="stretched-link mb-0" href="{{ route('admin.Dashboard.setting.index') }}">تنظیمات</a>
     ...
     <div class="row row-bordered overflow-visible g-0">
      <div class="dropdown-shortcuts-item col">
       ...
       <a class="stretched-link mb-0" href="{{ url('admin/pages/faq') }}">مرکز پشتیبانی</a>
      ...
      <div class="dropdown-shortcuts-item col">
       ...
       <a class="stretched-link mb-0" href="{{ url('admin/modal-examples') }}">مُـدال‌ها</a>
     ...
     <ul class="list-group list-group-flush">
      <li class="list-group-item list-group-item-action dropdown-notifications-item">
       <div class="d-flex">
        <div class="flex-shrink-0 me-3">
         <div class="avatar">
          <img alt class="h-auto rounded-circle" src="{{ asset('dr-assets/panel/img/pro.jpg') }}" />
         </div>
        </div>
      ...
      <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
       <div class="d-flex">
        <div class="flex-shrink-0 me-3">
         <div class="avatar">
          <img alt class="h-auto rounded-circle" src="{{ asset('assets/img/avatars/2.png') }}" />
         </div>
        </div>
        <div class="flex-grow-1">
      ...
      <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
       <div class="d-flex">
        <div class="flex-shrink-0 me-3">
         <div class="avatar">
          <img alt class="h-auto rounded-circle" src="{{ asset('assets/img/avatars/9.png') }}" />
         </div>
        </div>
        <div class="flex-grow-1">
      ...
      <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
       <div class="d-flex">
        <div class="flex-shrink-0 me-3">
         <div class="avatar">
          <img alt class="h-auto rounded-circle" src="{{ asset('assets/img/avatars/5.png') }}" />
         </div>
        </div>
        <div class="flex-grow-1">
      ...
      <li class="list-group-item list-group-item-action dropdown-notifications-item">
       <div class="d-flex">
        <div class="flex-shrink-0 me-3">
         <div class="avatar">
          <img alt class="h-auto rounded-circle" src="{{ asset('assets/img/avatars/6.png') }} " />
         </div>
        </div>
        <div class="flex-grow-1">
  ...
  <li class="nav-item navbar-dropdown dropdown-user dropdown">
   <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
    <div class="avatar avatar-online">
     <img src="{{ asset('dr-assets/panel/img/pro.jpg') }}" alt class="h-auto rounded-circle">
    </div>
   </a>
   <ul class="dropdown-menu dropdown-menu-end">
    <li>
     <a class="dropdown-item" href="{{ route('admin.content.users-management.users.profile.index') }}">
      <div class="d-flex">
       <div class="flex-shrink-0 me-3">
        <div class="avatar avatar-online">
         <img src="{{ asset('dr-assets/panel/img/pro.jpg') }}" alt class="h-auto rounded-circle">
    ...
    @endif
    <li>
     <a class="dropdown-item" href="{{ route('admin.Dashboard.setting.index') }}">
    ...
    @if (Auth::guard('manager')->check())
     <li>
      <a class="dropdown-item logout" href="{{ route('admin.auth.logout') }}">
