      ...
      <tbody>
       @forelse ($appointments as $index => $appointment)
        <tr>
         ...
         <td>
          <span class="badge {{ $appointment->status === 'scheduled' ? 'bg-label-info' : 'bg-label-danger' }}">
          ...
          <div class="dropdown">
           ...
           <ul class="dropdown-menu dropdown-menu-end">
            ...
            <li><a class="dropdown-item" href="#"
              wire:click.prevent="cancelAppointment({{ $appointment->id }})">لغو نوبت</a></li>
