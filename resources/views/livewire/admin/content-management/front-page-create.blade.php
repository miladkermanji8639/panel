                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control shadow-sm border-0 bg-white" wire:model="page_url"
                                dir="ltr">
                            @error('page_url') <span class="text-danger d-block mt-1">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            @error('tplname') <span class="text-danger d-block mt-1">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control shadow-sm border-0 bg-white" wire:model="lead"
                                rows="3"></textarea>
                            @error('lead') <span class="text-danger d-block mt-1">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div class="col-12 d-flex justify-content-between align-items-center gap-3 mt-4">
                            <a href="{{ route('admin.content-management.front-pages.index') }}"
