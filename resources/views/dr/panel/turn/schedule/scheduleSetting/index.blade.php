...
<div class="schedule-setting-content d-flex justify-content-center w-100 mt-4">
 <div class="schedule-setting-wrapper col-xs-12 col-sm-12 col-md-8 col-lg-8">
  <ul class="py-3 px-3">
   <div class="d-flex align-items-center border-bottom-1 cursor-pointer my-card-hover pb-3" tabindex="0" role="button"
   ...
   <div class="d-flex align-items-center mt-3 border-bottom-1 cursor-pointer my-card-hover pb-3" tabindex="0"
    role="button" onclick="location.href='{{ route('dr-vacation') }}'">
   ...
   <div class="d-flex align-items-center mt-3 border-bottom-1 cursor-pointer my-card-hover pb-3" tabindex="0"
    role="button" onclick="location.href='{{ route('doctor-blocking-users.index') }}'">
    <div class="d-flex align-items-center justify-content-center bg-gray-500 my-svg-setting-nobat">
