...
@if (count($appointments) > 0) 
       ...
       <div>
        <div class="d-flex align-items-center">
         ...
         <div class="mx-2">
          ...
          <span class="font-size-13"> {{ $appointment->doctor->specialty ?? 'نامشخص' }}</span>
         </div>
  
        </div>
       </div>
       <div>
        <span class="font-size-13 my-sm-badge">
         {{ $appointment->status == 'attended' ? 'ویزیت شده' : 'در انتظار ویزیت' }}</span>
      ...
      <div class="bg-light w-100 border-radius-6">
       <div class="d-flex flex-column w-100 bg-light p-3 px-4  cursor-pointer">
        <div class="d-flex align-items-center justify-content-between"><span
          ...
          نوبت:</span><span
          class="text-sm font-weight-bold font-size-13 mt-2">{{ \Morilog\Jalali\Jalalian::fromCarbon(\Carbon\Carbon::parse($appointment->appointment_date))->format('Y/m/d H:i') }}</span>
        </div>
        <div class="d-flex align-items-center justify-content-between"><span
          class="font-size-13 mt-2 font-weight-bold">مراجعه
          کننده:</span><span class="text-sm font-weight-bold font-size-13 mt-2"> {{ $appointment->patient->first_name }}
        ...
        <div class="d-flex align-items-center justify-content-between"><span class="font-size-13 mt-2 font-weight-bold">کد
          پیگیری:</span><span class="text-sm font-weight-bold font-size-13 mt-2">{{ $appointment->tracking_code }}</span>
        </div>
        <div class="d-flex align-items-center justify-content-between"><span
          class="font-size-13 mt-2 font-weight-bold">میانگین
          زمان انتظار در مطب:</span><span class="text-sm font-weight-bold font-size-13 mt-2">30 دقیقه</span></div>
       </div>
      </div>
     </div>
     <div class="d-flex">
      <a href="https://maps.google.com/maps?daddr=35.700690036108,51.359184980392&amp;amp;ll=" target="_blank"
       rel="noreferrer" class="d-flex align-items-center w-100 p-3 px-0" data-testid="location__link">
       <div class="d-flex align-items-center justify-content-center w-12 "><svg width="26" height="26"
     ...
     <div class="p-3">
      <div class="d-flex align-items-center justify-content-between w-100 bg-light p-3 px-4 border-radius-6"><span
        ...
        <span class="text-sm font-weight-bold ml-2 text-info">ثبت
         نظر</span>
        <svg class="mx-1" width="10" height="12" viewBox="0 0 7 11" fill="none"
   ...
   @else
     ...
     <div class="alert alert-info w-100 text-center"><p class="font-weight-bold">نوبتی یافت نشد . </p></div>
