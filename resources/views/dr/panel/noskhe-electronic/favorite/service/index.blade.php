...
@endsection
@section('content')
  @section('bread-crumb-title',' اقلام  پراستفاده ')
   ...
   <div class="">
    <div class="top-noskhe-create">
     <form action="" method="post">
      <div class="d-flex justify-content-between align-items-center gap-20 w-100">
       <div class="d-flex justify-content-between gap-20 w-100 align-items-center ">
    ...
    <div class="lists-of mt-4 w-100">
     <div class="table-responsive">
      ...
      <div style="display: flex; gap: 1rem; justify-content: center; align-items: center;"><img
        ...
        alt="" style="width: 3rem;"><span style="font-weight: 500; opacity: 0.7;" class="text-nothing">خدمتی در این
        دسته بندی وجود
        ندارد.</span></div>
     </div>
    </div>
