      ...
      ->group(function () {
        ...
        Route::prefix('turn')->group(function () {
          Route::prefix('schedule')->group(function () {
            ...
            Route::get('/my-appointments/by-date', [DrScheduleController::class, 'showByDateAppointments'])
              ->name('dr.turn.my-appointments.by-date');
            ...
            Route::post('manual_nobat/store', [ManualNobatController::class, 'store'])
              ->name('manual-nobat.store');
            Route::post('manual-nobat/store-with-user', [ManualNobatController::class, 'storeWithUser'])
              ->name('manual-nobat.store-with-user');
            ...
            Route::post('/save-appointment-settings', [ScheduleSettingController::class, 'saveAppointmentSettings'])
