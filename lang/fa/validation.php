...
return [
    'custom' => [
        'ita_phone' => [
            'regex' => 'شماره موبایل ایتا را به درستی وارد کنید.',
        ],
        'whatsapp_phone' => [
            'regex' => 'شماره موبایل واتس‌اپ را به درستی وارد کنید.',
        ],
    ],
    ...
    'attributes' => [
        ...
        "email" => "پست الکترونیکی",
         "new_email"=> "ایمیل",
 "new_source_url"=> "آدرس مبدا",
 "new_destination_url"=> "آدرس مقصد",
        "first_name" => "نام",
        ...
        "price_shipping" => " قیمت حمل و نقل",
        "national_code" => "کد ملی",
        "town" => " استان",
        "specific_recipient" => " شماره تماس گیرنده",
    ...
    "regex" => ":attribute رابه درستی واردکنید   ",
    ...
    'uuid' => ':attribute باید یک فرمت درست آیدی شما باشد.',
];